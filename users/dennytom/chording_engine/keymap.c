...
enum pseudolayers {
    ALWAYS_ON, QWERTY, NUM, FNC, NAV, MS
};
...
uint8_t counter_2 = 0;
const struct Chord chord_2 PROGMEM = {H_TOP1, QWERTY, &state_2, &counter_2, KC_ESC, NAV, key_layer_dance};
...
const struct Chord chord_25 PROGMEM = {H_BOT1, QWERTY, &state_25, &counter_25, KC_TAB, MS, key_layer_dance};
...
const struct Chord chord_39 PROGMEM = {H_THU3, QWERTY, &state_39, NULL, KC_BSPC, 0, single_dance};
...
const struct Chord chord_43 PROGMEM = {H_TOP1, NUM, &state_43, NULL, KC_GRAVE, 0, single_dance};
uint8_t state_44 = IDLE;
const struct Chord chord_44 PROGMEM = {H_TOP2, NUM, &state_44, NULL, KC_1, 0, single_dance};
uint8_t state_45 = IDLE;
const struct Chord chord_45 PROGMEM = {H_TOP3, NUM, &state_45, NULL, KC_2, 0, single_dance};
uint8_t state_46 = IDLE;
const struct Chord chord_46 PROGMEM = {H_TOP4, NUM, &state_46, NULL, KC_3, 0, single_dance};
uint8_t state_47 = IDLE;
const struct Chord chord_47 PROGMEM = {H_TOP5, NUM, &state_47, NULL, KC_4, 0, single_dance};
uint8_t state_48 = IDLE;
const struct Chord chord_48 PROGMEM = {H_TOP6, NUM, &state_48, NULL, KC_5, 0, single_dance};
uint8_t state_49 = IDLE;
const struct Chord chord_49 PROGMEM = {H_TOP7, NUM, &state_49, NULL, KC_6, 0, single_dance};
uint8_t state_50 = IDLE;
const struct Chord chord_50 PROGMEM = {H_TOP8, NUM, &state_50, NULL, KC_7, 0, single_dance};
uint8_t state_51 = IDLE;
const struct Chord chord_51 PROGMEM = {H_TOP9, NUM, &state_51, NULL, KC_8, 0, single_dance};
uint8_t state_52 = IDLE;
const struct Chord chord_52 PROGMEM = {H_TOP10, NUM, &state_52, NULL, KC_9, 0, single_dance};
uint8_t state_53 = IDLE;
const struct Chord chord_53 PROGMEM = {H_TOP11, NUM, &state_53, NULL, KC_0, 0, single_dance};
uint8_t state_54 = IDLE;
const struct Chord chord_54 PROGMEM = {H_TOP12, NUM, &state_54, NULL, KC_MINUS, 0, single_dance};
uint8_t state_55 = IDLE;
const struct Chord chord_55 PROGMEM = {H_TOP3 + H_BOT3, NUM, &state_55, NULL, KC_LALT, 0, single_dance};
uint8_t state_56 = IDLE;
const struct Chord chord_56 PROGMEM = {H_TOP4 + H_BOT4, NUM, &state_56, NULL, KC_LCTL, 0, single_dance};
uint8_t state_57 = IDLE;
const struct Chord chord_57 PROGMEM = {H_TOP5 + H_BOT5, NUM, &state_57, NULL, KC_LSFT, 0, single_dance};
uint8_t state_58 = IDLE;
const struct Chord chord_58 PROGMEM = {H_TOP6 + H_BOT6, NUM, &state_58, NULL, KC_LGUI, 0, single_dance};
uint8_t state_59 = IDLE;
const struct Chord chord_59 PROGMEM = {H_TOP7 + H_BOT7, NUM, &state_59, NULL, KC_RGUI, 0, single_dance};
uint8_t state_60 = IDLE;
const struct Chord chord_60 PROGMEM = {H_TOP8 + H_BOT8, NUM, &state_60, NULL, KC_RSFT, 0, single_dance};
uint8_t state_61 = IDLE;
const struct Chord chord_61 PROGMEM = {H_TOP9 + H_BOT9, NUM, &state_61, NULL, KC_RCTL, 0, single_dance};
uint8_t state_62 = IDLE;
const struct Chord chord_62 PROGMEM = {H_TOP10 + H_BOT10, NUM, &state_62, NULL, KC_RALT, 0, single_dance};
uint8_t state_63 = IDLE;
const struct Chord chord_63 PROGMEM = {H_BOT12, NUM, &state_63, NULL, KC_EQUAL, 0, single_dance};
uint8_t state_64 = IDLE;
const struct Chord chord_64 PROGMEM = {H_TOP2, FNC, &state_64, NULL, KC_F1, 0, single_dance};
uint8_t state_65 = IDLE;
const struct Chord chord_65 PROGMEM = {H_TOP3, FNC, &state_65, NULL, KC_F2, 0, single_dance};
uint8_t state_66 = IDLE;
const struct Chord chord_66 PROGMEM = {H_TOP4, FNC, &state_66, NULL, KC_F3, 0, single_dance};
uint8_t state_67 = IDLE;
const struct Chord chord_67 PROGMEM = {H_TOP5, FNC, &state_67, NULL, KC_F4, 0, single_dance};
uint8_t state_68 = IDLE;
const struct Chord chord_68 PROGMEM = {H_TOP6, FNC, &state_68, NULL, KC_F5, 0, single_dance};
uint8_t state_69 = IDLE;
const struct Chord chord_69 PROGMEM = {H_TOP7, FNC, &state_69, NULL, KC_F6, 0, single_dance};
uint8_t state_70 = IDLE;
const struct Chord chord_70 PROGMEM = {H_TOP8, FNC, &state_70, NULL, KC_F7, 0, single_dance};
uint8_t state_71 = IDLE;
const struct Chord chord_71 PROGMEM = {H_TOP9, FNC, &state_71, NULL, KC_F8, 0, single_dance};
uint8_t state_72 = IDLE;
const struct Chord chord_72 PROGMEM = {H_TOP10, FNC, &state_72, NULL, KC_F9, 0, single_dance};
uint8_t state_73 = IDLE;
const struct Chord chord_73 PROGMEM = {H_TOP11, FNC, &state_73, NULL, KC_F10, 0, single_dance};
uint8_t state_74 = IDLE;
const struct Chord chord_74 PROGMEM = {H_TOP12, FNC, &state_74, NULL, KC_F11, 0, single_dance};
uint8_t state_75 = IDLE;
const struct Chord chord_75 PROGMEM = {H_TOP3 + H_BOT3, FNC, &state_75, NULL, KC_LALT, 0, single_dance};
uint8_t state_76 = IDLE;
const struct Chord chord_76 PROGMEM = {H_TOP4 + H_BOT4, FNC, &state_76, NULL, KC_LCTL, 0, single_dance};
uint8_t state_77 = IDLE;
const struct Chord chord_77 PROGMEM = {H_TOP5 + H_BOT5, FNC, &state_77, NULL, KC_LSFT, 0, single_dance};
uint8_t state_78 = IDLE;
const struct Chord chord_78 PROGMEM = {H_TOP6 + H_BOT6, FNC, &state_78, NULL, KC_LGUI, 0, single_dance};
uint8_t state_79 = IDLE;
const struct Chord chord_79 PROGMEM = {H_TOP7 + H_BOT7, FNC, &state_79, NULL, KC_RGUI, 0, single_dance};
uint8_t state_80 = IDLE;
const struct Chord chord_80 PROGMEM = {H_TOP8 + H_BOT8, FNC, &state_80, NULL, KC_RSFT, 0, single_dance};
uint8_t state_81 = IDLE;
const struct Chord chord_81 PROGMEM = {H_TOP9 + H_BOT9, FNC, &state_81, NULL, KC_RCTL, 0, single_dance};
uint8_t state_82 = IDLE;
const struct Chord chord_82 PROGMEM = {H_TOP10 + H_BOT10, FNC, &state_82, NULL, KC_RALT, 0, single_dance};
uint8_t state_83 = IDLE;
const struct Chord chord_83 PROGMEM = {H_BOT12, FNC, &state_83, NULL, KC_F12, 0, single_dance};
uint8_t state_84 = IDLE;
const struct Chord chord_84 PROGMEM = {H_TOP8, NAV, &state_84, NULL, KC_HOME, 0, single_dance};
uint8_t state_85 = IDLE;
const struct Chord chord_85 PROGMEM = {H_TOP9, NAV, &state_85, NULL, KC_UP, 0, single_dance};
uint8_t state_86 = IDLE;
const struct Chord chord_86 PROGMEM = {H_TOP10, NAV, &state_86, NULL, KC_END, 0, single_dance};
uint8_t state_87 = IDLE;
const struct Chord chord_87 PROGMEM = {H_TOP11, NAV, &state_87, NULL, KC_PGUP, 0, single_dance};
uint8_t state_88 = IDLE;
const struct Chord chord_88 PROGMEM = {H_TOP3 + H_BOT3, NAV, &state_88, NULL, KC_LALT, 0, single_dance};
uint8_t state_89 = IDLE;
const struct Chord chord_89 PROGMEM = {H_TOP4 + H_BOT4, NAV, &state_89, NULL, KC_LCTL, 0, single_dance};
uint8_t state_90 = IDLE;
const struct Chord chord_90 PROGMEM = {H_TOP5 + H_BOT5, NAV, &state_90, NULL, KC_LSFT, 0, single_dance};
uint8_t state_91 = IDLE;
const struct Chord chord_91 PROGMEM = {H_TOP6 + H_BOT6, NAV, &state_91, NULL, KC_LGUI, 0, single_dance};
uint8_t state_92 = IDLE;
const struct Chord chord_92 PROGMEM = {H_BOT8, NAV, &state_92, NULL, KC_LEFT, 0, single_dance};
uint8_t state_93 = IDLE;
const struct Chord chord_93 PROGMEM = {H_BOT9, NAV, &state_93, NULL, KC_DOWN, 0, single_dance};
uint8_t state_94 = IDLE;
const struct Chord chord_94 PROGMEM = {H_BOT10, NAV, &state_94, NULL, KC_RIGHT, 0, single_dance};
uint8_t state_95 = IDLE;
const struct Chord chord_95 PROGMEM = {H_BOT11, NAV, &state_95, NULL, KC_PGDN, 0, single_dance};
uint8_t state_96 = IDLE;
const struct Chord chord_96 PROGMEM = {H_TOP8, MS, &state_96, NULL, KC_BTN1, 0, single_dance};
uint8_t state_97 = IDLE;
const struct Chord chord_97 PROGMEM = {H_TOP9, MS, &state_97, NULL, KC_MS_U, 0, single_dance};
uint8_t state_98 = IDLE;
const struct Chord chord_98 PROGMEM = {H_TOP10, MS, &state_98, NULL, KC_BTN2, 0, single_dance};
uint8_t state_99 = IDLE;
const struct Chord chord_99 PROGMEM = {H_TOP11, MS, &state_99, NULL, KC_WH_U, 0, single_dance};
uint8_t state_100 = IDLE;
const struct Chord chord_100 PROGMEM = {H_TOP3 + H_BOT3, MS, &state_100, NULL, KC_LALT, 0, single_dance};
uint8_t state_101 = IDLE;
const struct Chord chord_101 PROGMEM = {H_TOP4 + H_BOT4, MS, &state_101, NULL, KC_LCTL, 0, single_dance};
uint8_t state_102 = IDLE;
const struct Chord chord_102 PROGMEM = {H_TOP5 + H_BOT5, MS, &state_102, NULL, KC_LSFT, 0, single_dance};
uint8_t state_103 = IDLE;
const struct Chord chord_103 PROGMEM = {H_TOP6 + H_BOT6, MS, &state_103, NULL, KC_LGUI, 0, single_dance};
uint8_t state_104 = IDLE;
const struct Chord chord_104 PROGMEM = {H_BOT8, MS, &state_104, NULL, KC_MS_L, 0, single_dance};
uint8_t state_105 = IDLE;
const struct Chord chord_105 PROGMEM = {H_BOT9, MS, &state_105, NULL, KC_MS_D, 0, single_dance};
uint8_t state_106 = IDLE;
const struct Chord chord_106 PROGMEM = {H_BOT10, MS, &state_106, NULL, KC_MS_R, 0, single_dance};
uint8_t state_107 = IDLE;
const struct Chord chord_107 PROGMEM = {H_BOT11, MS, &state_107, NULL, KC_WH_D, 0, single_dance};
