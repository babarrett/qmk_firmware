...
enum pseudolayers {
    ALWAYS_ON, COLEMAK, NUM, SYM, MOVE, MEDIA, GAME, STENO
};
...
// Add all chords
    ...
    const struct Chord chord_64 PROGMEM = {H_TOP1, NUM, &state_64, NULL, KC_LPRN, 0, single_dance};
    ...
    const struct Chord chord_65 PROGMEM = {H_TOP2, NUM, &state_65, NULL, KC_1, 0, single_dance};
    ...
    const struct Chord chord_66 PROGMEM = {H_TOP3, NUM, &state_66, NULL, KC_2, 0, single_dance};
    ...
    const struct Chord chord_67 PROGMEM = {H_TOP4, NUM, &state_67, NULL, KC_3, 0, single_dance};
    ...
    const struct Chord chord_68 PROGMEM = {H_TOP5, NUM, &state_68, NULL, KC_4, 0, single_dance};
    ...
    const struct Chord chord_69 PROGMEM = {H_TOP6, NUM, &state_69, NULL, KC_5, 0, single_dance};
    ...
    const struct Chord chord_70 PROGMEM = {H_TOP7, NUM, &state_70, NULL, KC_6, 0, single_dance};
    ...
    const struct Chord chord_71 PROGMEM = {H_TOP8, NUM, &state_71, NULL, KC_7, 0, single_dance};
    ...
    const struct Chord chord_72 PROGMEM = {H_TOP9, NUM, &state_72, NULL, KC_8, 0, single_dance};
    ...
    const struct Chord chord_73 PROGMEM = {H_TOP10, NUM, &state_73, NULL, KC_9, 0, single_dance};
    ...
    const struct Chord chord_74 PROGMEM = {H_TOP11, NUM, &state_74, NULL, KC_0, 0, single_dance};
    ...
    const struct Chord chord_75 PROGMEM = {H_TOP12, NUM, &state_75, NULL, KC_RPRN, 0, single_dance};
    ...
    const struct Chord chord_76 PROGMEM = {H_TOP1 + H_BOT1, NUM, &state_76, NULL, KC_EQL, 0, single_dance};
    ...
    const struct Chord chord_77 PROGMEM = {H_TOP2 + H_BOT2, NUM, &state_77, NULL, KC_PLUS, 0, single_dance};
    ...
    const struct Chord chord_78 PROGMEM = {H_TOP3 + H_BOT3, NUM, &state_78, NULL, KC_MINS, 0, single_dance};
    ...
    const struct Chord chord_79 PROGMEM = {H_TOP4 + H_BOT4, NUM, &state_79, NULL, KC_ASTR, 0, single_dance};
    ...
    const struct Chord chord_80 PROGMEM = {H_TOP5 + H_BOT5, NUM, &state_80, NULL, KC_SLASH, 0, single_dance};
    ...
    const struct Chord chord_81 PROGMEM = {H_TOP6 + H_BOT6, NUM, &state_81, NULL, KC_DOT, 0, single_dance};
    ...
    const struct Chord chord_82 PROGMEM = {H_TOP7 + H_BOT7, NUM, &state_82, NULL, KC_COMMA, 0, single_dance};
    ...
    const struct Chord chord_83 PROGMEM = {H_TOP8 + H_BOT8, NUM, &state_83, NULL, KC_SLASH, 0, single_dance};
    ...
    const struct Chord chord_84 PROGMEM = {H_TOP9 + H_BOT9, NUM, &state_84, NULL, KC_ASTR, 0, single_dance};
    ...
    const struct Chord chord_85 PROGMEM = {H_TOP10 + H_BOT10, NUM, &state_85, NULL, KC_MINS, 0, single_dance};
    ...
    const struct Chord chord_86 PROGMEM = {H_TOP11 + H_BOT11, NUM, &state_86, NULL, KC_PLUS, 0, single_dance};
    ...
    const struct Chord chord_87 PROGMEM = {H_TOP12 + H_BOT12, NUM, &state_87, NULL, KC_EQL, 0, single_dance};
    ...
    const struct Chord chord_88 PROGMEM = {H_BOT1, NUM, &state_88, NULL, KC_LSFT, 0, single_dance};
    ...
    const struct Chord chord_89 PROGMEM = {H_BOT2, NUM, &state_89, NULL, KC_F1, 0, single_dance};
    ...
    const struct Chord chord_90 PROGMEM = {H_BOT3, NUM, &state_90, NULL, KC_F2, 0, single_dance};
    ...
    const struct Chord chord_91 PROGMEM = {H_BOT4, NUM, &state_91, NULL, KC_F3, 0, single_dance};
    ...
    const struct Chord chord_92 PROGMEM = {H_BOT5, NUM, &state_92, NULL, KC_F4, 0, single_dance};
    ...
    const struct Chord chord_93 PROGMEM = {H_BOT6, NUM, &state_93, NULL, KC_F5, 0, single_dance};
    ...
    const struct Chord chord_94 PROGMEM = {H_BOT7, NUM, &state_94, NULL, KC_F6, 0, single_dance};
    ...
    const struct Chord chord_95 PROGMEM = {H_BOT8, NUM, &state_95, NULL, KC_F7, 0, single_dance};
    ...
    const struct Chord chord_96 PROGMEM = {H_BOT9, NUM, &state_96, NULL, KC_F8, 0, single_dance};
    ...
    const struct Chord chord_97 PROGMEM = {H_BOT10, NUM, &state_97, NULL, KC_F9, 0, single_dance};
    ...
    const struct Chord chord_98 PROGMEM = {H_BOT11, NUM, &state_98, NULL, KC_F10, 0, single_dance};
    ...
    const struct Chord chord_99 PROGMEM = {H_BOT12, NUM, &state_99, NULL, KC_RSFT, 0, single_dance};
    ...
    const struct Chord chord_100 PROGMEM = {H_THU1, NUM, &state_100, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_102 PROGMEM = {H_THU3, NUM, &state_102, NULL, KC_RSFT, 0, single_dance};
    ...
    const struct Chord chord_103 PROGMEM = {H_THU4, NUM, &state_103, NULL, KC_ENTER, 0, single_dance};
    ...
    const struct Chord chord_105 PROGMEM = {H_THU6, NUM, &state_105, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_106 PROGMEM = {H_BOT2 + H_BOT3, NUM, &state_106, NULL, KC_F11, 0, single_dance};
    ...
    const struct Chord chord_107 PROGMEM = {H_BOT3 + H_BOT4, NUM, &state_107, NULL, KC_LALT, 0, single_dance};
    ...
    const struct Chord chord_108 PROGMEM = {H_BOT4 + H_BOT5, NUM, &state_108, NULL, KC_LGUI, 0, single_dance};
    ...
    const struct Chord chord_109 PROGMEM = {H_BOT5 + H_BOT6, NUM, &state_109, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_110 PROGMEM = {H_BOT7 + H_BOT8, NUM, &state_110, NULL, KC_RCTL, 0, single_dance};
    ...
    const struct Chord chord_111 PROGMEM = {H_BOT8 + H_BOT9, NUM, &state_111, NULL, KC_RGUI, 0, single_dance};
    ...
    const struct Chord chord_112 PROGMEM = {H_BOT9 + H_BOT10, NUM, &state_112, NULL, KC_RALT, 0, single_dance};
    ...
    const struct Chord chord_113 PROGMEM = {H_BOT10 + H_BOT11, NUM, &state_113, NULL, KC_F12, 0, single_dance};
    ...
    const struct Chord chord_114 PROGMEM = {H_BOT7 + H_BOT8 + H_BOT9 + H_BOT10, NUM, &state_114, &counter_114, 0, 0, function_114};
    ...
    const struct Chord chord_115 PROGMEM = {H_BOT3 + H_BOT4 + H_BOT5 + H_BOT6, NUM, &state_115, &counter_115, 0, 0, function_115};
    ...
    const struct Chord chord_116 PROGMEM = {H_TOP2, SYM, &state_116, NULL, KC_GRV, 0, single_dance};
    ...
    const struct Chord chord_117 PROGMEM = {H_TOP3, SYM, &state_117, NULL, KC_LBRC, 0, single_dance};
    ...
    const struct Chord chord_118 PROGMEM = {H_TOP4, SYM, &state_118, NULL, KC_LCBR, 0, single_dance};
    ...
    const struct Chord chord_119 PROGMEM = {H_TOP5, SYM, &state_119, NULL, KC_LPRN, 0, single_dance};
    ...
    const struct Chord chord_120 PROGMEM = {H_TOP6, SYM, &state_120, NULL, KC_LABK, 0, single_dance};
    ...
    const struct Chord chord_121 PROGMEM = {H_TOP7, SYM, &state_121, NULL, KC_RABK, 0, single_dance};
    ...
    const struct Chord chord_122 PROGMEM = {H_TOP8, SYM, &state_122, NULL, KC_RPRN, 0, single_dance};
    ...
    const struct Chord chord_123 PROGMEM = {H_TOP9, SYM, &state_123, NULL, KC_RCBR, 0, single_dance};
    ...
    const struct Chord chord_124 PROGMEM = {H_TOP10, SYM, &state_124, NULL, KC_RBRC, 0, single_dance};
    ...
    const struct Chord chord_125 PROGMEM = {H_TOP11, SYM, &state_125, NULL, KC_QUES, 0, single_dance};
    ...
    const struct Chord chord_126 PROGMEM = {H_TOP12, SYM, &state_126, NULL, KC_RCTL, 0, single_dance};
    ...
    const struct Chord chord_127 PROGMEM = {H_TOP2 + H_BOT2, SYM, &state_127, NULL, KC_TILDE, 0, single_dance};
    ...
    const struct Chord chord_128 PROGMEM = {H_TOP3 + H_BOT3, SYM, &state_128, NULL, KC_MINS, 0, single_dance};
    ...
    const struct Chord chord_129 PROGMEM = {H_TOP4 + H_BOT4, SYM, &state_129, NULL, KC_QUOT, 0, single_dance};
    ...
    const struct Chord chord_130 PROGMEM = {H_TOP5 + H_BOT5, SYM, &state_130, NULL, KC_COLN, 0, single_dance};
    ...
    const struct Chord chord_131 PROGMEM = {H_TOP6 + H_BOT6, SYM, &state_131, NULL, KC_UNDS, 0, single_dance};
    ...
    const struct Chord chord_132 PROGMEM = {H_TOP7 + H_BOT7, SYM, &state_132, NULL, KC_BSLS, 0, single_dance};
    ...
    const struct Chord chord_133 PROGMEM = {H_TOP8 + H_BOT8, SYM, &state_133, NULL, KC_EQL, 0, single_dance};
    ...
    const struct Chord chord_134 PROGMEM = {H_TOP9 + H_BOT9, SYM, &state_134, NULL, KC_DQUO, 0, single_dance};
    ...
    const struct Chord chord_135 PROGMEM = {H_TOP10 + H_BOT10, SYM, &state_135, NULL, KC_PLUS, 0, single_dance};
    ...
    const struct Chord chord_136 PROGMEM = {H_TOP11 + H_BOT11, SYM, &state_136, NULL, KC_BSLS, 0, single_dance};
    ...
    const struct Chord chord_137 PROGMEM = {H_TOP12 + H_BOT12, SYM, &state_137, NULL, KC_RGUI, 0, single_dance};
    ...
    const struct Chord chord_138 PROGMEM = {H_BOT2, SYM, &state_138, NULL, KC_EXLM, 0, single_dance};
    ...
    const struct Chord chord_139 PROGMEM = {H_BOT3, SYM, &state_139, NULL, KC_AT, 0, single_dance};
    ...
    const struct Chord chord_140 PROGMEM = {H_BOT4, SYM, &state_140, NULL, KC_HASH, 0, single_dance};
    ...
    const struct Chord chord_141 PROGMEM = {H_BOT5, SYM, &state_141, NULL, KC_DLR, 0, single_dance};
    ...
    const struct Chord chord_142 PROGMEM = {H_BOT6, SYM, &state_142, NULL, KC_PERC, 0, single_dance};
    ...
    const struct Chord chord_143 PROGMEM = {H_BOT7, SYM, &state_143, NULL, KC_CIRC, 0, single_dance};
    ...
    const struct Chord chord_144 PROGMEM = {H_BOT8, SYM, &state_144, NULL, KC_AMPR, 0, single_dance};
    ...
    const struct Chord chord_145 PROGMEM = {H_BOT9, SYM, &state_145, NULL, KC_ASTR, 0, single_dance};
    ...
    const struct Chord chord_146 PROGMEM = {H_BOT10, SYM, &state_146, NULL, KC_PIPE, 0, single_dance};
    ...
    const struct Chord chord_147 PROGMEM = {H_BOT11, SYM, &state_147, NULL, KC_QUES, 0, single_dance};
    ...
    const struct Chord chord_148 PROGMEM = {H_BOT12, SYM, &state_148, NULL, KC_RALT, 0, single_dance};
    ...
    const struct Chord chord_149 PROGMEM = {H_THU1, SYM, &state_149, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_150 PROGMEM = {H_THU2, SYM, &state_150, NULL, KC_SPACE, 0, single_dance};
    ...
    const struct Chord chord_151 PROGMEM = {H_THU5, SYM, &state_151, NULL, KC_SPACE, 0, single_dance};
    ...
    const struct Chord chord_152 PROGMEM = {H_THU6, SYM, &state_152, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_153 PROGMEM = {H_BOT3 + H_BOT4, SYM, &state_153, NULL, KC_LALT, 0, single_dance};
    ...
    const struct Chord chord_154 PROGMEM = {H_BOT4 + H_BOT5, SYM, &state_154, NULL, KC_LGUI, 0, single_dance};
    ...
    const struct Chord chord_155 PROGMEM = {H_BOT5 + H_BOT6, SYM, &state_155, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_156 PROGMEM = {H_BOT7 + H_BOT8, SYM, &state_156, NULL, KC_RCTL, 0, single_dance};
    ...
    const struct Chord chord_157 PROGMEM = {H_BOT8 + H_BOT9, SYM, &state_157, NULL, KC_RGUI, 0, single_dance};
    ...
    const struct Chord chord_158 PROGMEM = {H_BOT9 + H_BOT10, SYM, &state_158, NULL, KC_RALT, 0, single_dance};
    ...
    const struct Chord chord_159 PROGMEM = {H_TOP2, MOVE, &state_159, &counter_159, 0, 0, function_159};
    ...
    const struct Chord chord_160 PROGMEM = {H_TOP3, MOVE, &state_160, NULL, KC_HOME, 0, single_dance};
    ...
    const struct Chord chord_161 PROGMEM = {H_TOP4, MOVE, &state_161, NULL, KC_UP, 0, single_dance};
    ...
    const struct Chord chord_162 PROGMEM = {H_TOP5, MOVE, &state_162, NULL, KC_PGUP, 0, single_dance};
    ...
    const struct Chord chord_163 PROGMEM = {H_TOP6, MOVE, &state_163, &counter_163, 0, 0, function_163};
    ...
    const struct Chord chord_164 PROGMEM = {H_TOP9, MOVE, &state_164, NULL, KC_UP, 0, single_dance};
    ...
    const struct Chord chord_165 PROGMEM = {H_TOP1 + H_BOT1, MOVE, &state_165, NULL, KC_INS, 0, single_dance};
    ...
    void function_166(const struct Chord* self) {
        switch (*self->state) {
            case ACTIVATED:
    ...
    uint8_t counter_166 = 0;
    const struct Chord chord_166 PROGMEM = {H_TOP2 + H_BOT2, MOVE, &state_166, &counter_166, 0, 0, function_166};
    ...
    const struct Chord chord_167 PROGMEM = {H_TOP3 + H_BOT3, MOVE, &state_167, NULL, KC_END, 0, single_dance};
    ...
    const struct Chord chord_168 PROGMEM = {H_TOP5 + H_BOT5, MOVE, &state_168, NULL, KC_PGDN, 0, single_dance};
    ...
    const struct Chord chord_169 PROGMEM = {H_TOP6 + H_BOT6, MOVE, &state_169, &counter_169, 0, 0, function_169};
    ...
    const struct Chord chord_170 PROGMEM = {H_TOP8 + H_BOT8, MOVE, &state_170, NULL, KC_LEFT, 0, single_dance};
    ...
    const struct Chord chord_171 PROGMEM = {H_TOP9 + H_BOT9, MOVE, &state_171, NULL, KC_DOWN, 0, single_dance};
    ...
    const struct Chord chord_172 PROGMEM = {H_TOP10 + H_BOT10, MOVE, &state_172, NULL, KC_RIGHT, 0, single_dance};
    ...
    const struct Chord chord_173 PROGMEM = {H_BOT1, MOVE, &state_173, NULL, KC_LSFT, 0, single_dance};
    ...
    void function_174(const struct Chord* self) {
        switch (*self->state) {
            case ACTIVATED:
    ...
    const struct Chord chord_174 PROGMEM = {H_BOT2, MOVE, &state_174, &counter_174, 0, 0, function_174};
    ...
    const struct Chord chord_175 PROGMEM = {H_BOT3, MOVE, &state_175, NULL, KC_LEFT, 0, single_dance};
    ...
    const struct Chord chord_176 PROGMEM = {H_BOT4, MOVE, &state_176, NULL, KC_DOWN, 0, single_dance};
    ...
    const struct Chord chord_177 PROGMEM = {H_BOT5, MOVE, &state_177, NULL, KC_RIGHT, 0, single_dance};
    ...
    void function_178(const struct Chord* self) {
        switch (*self->state) {
            case ACTIVATED:
    ...
    const struct Chord chord_178 PROGMEM = {H_BOT6, MOVE, &state_178, &counter_178, 0, 0, function_178};
    ...
    const struct Chord chord_179 PROGMEM = {H_BOT8, MOVE, &state_179, NULL, KC_LEFT, 0, single_dance};
    ...
    const struct Chord chord_180 PROGMEM = {H_BOT9, MOVE, &state_180, NULL, KC_DOWN, 0, single_dance};
    ...
    const struct Chord chord_181 PROGMEM = {H_BOT10, MOVE, &state_181, NULL, KC_RIGHT, 0, single_dance};
    ...
    const struct Chord chord_182 PROGMEM = {H_BOT12, MOVE, &state_182, NULL, KC_RSFT, 0, single_dance};
    ...
    const struct Chord chord_183 PROGMEM = {H_BOT3 + H_BOT4, MOVE, &state_183, NULL, KC_LALT, 0, single_dance};
    ...
    const struct Chord chord_184 PROGMEM = {H_BOT4 + H_BOT5, MOVE, &state_184, NULL, KC_LGUI, 0, single_dance};
    ...
    const struct Chord chord_185 PROGMEM = {H_BOT5 + H_BOT6, MOVE, &state_185, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_186 PROGMEM = {H_BOT7 + H_BOT8, MOVE, &state_186, NULL, KC_RCTL, 0, single_dance};
    ...
    const struct Chord chord_187 PROGMEM = {H_BOT8 + H_BOT9, MOVE, &state_187, NULL, KC_RGUI, 0, single_dance};
    ...
    const struct Chord chord_188 PROGMEM = {H_BOT9 + H_BOT10, MOVE, &state_188, NULL, KC_RALT, 0, single_dance};
    ...
    const struct Chord chord_189 PROGMEM = {H_TOP8, MEDIA, &state_189, NULL, KC_MPRV, 0, single_dance};
    ...
    const struct Chord chord_190 PROGMEM = {H_TOP9, MEDIA, &state_190, NULL, KC_MPLY, 0, single_dance};
    ...
    const struct Chord chord_191 PROGMEM = {H_TOP10, MEDIA, &state_191, NULL, KC_MPLY, 0, single_dance};
    ...
    const struct Chord chord_192 PROGMEM = {H_TOP11, MEDIA, &state_192, NULL, KC_MNXT, 0, single_dance};
    ...
    const struct Chord chord_193 PROGMEM = {H_TOP12, MEDIA, &state_193, NULL, KC_VOLU, 0, single_dance};
    ...
    const struct Chord chord_194 PROGMEM = {H_TOP12 + H_BOT12, MEDIA, &state_194, NULL, KC_MUTE, 0, single_dance};
    ...
    const struct Chord chord_195 PROGMEM = {H_BOT12, MEDIA, &state_195, NULL, KC_VOLD, 0, single_dance};
    ...
    const struct Chord chord_196 PROGMEM = {H_TOP1, GAME, &state_196, NULL, KC_TAB, 0, single_dance};
    ...
    const struct Chord chord_197 PROGMEM = {H_TOP2, GAME, &state_197, NULL, KC_Q, 0, single_dance};
    ...
    const struct Chord chord_198 PROGMEM = {H_TOP3, GAME, &state_198, NULL, KC_W, 0, single_dance};
    ...
    const struct Chord chord_199 PROGMEM = {H_TOP4, GAME, &state_199, NULL, KC_F, 0, single_dance};
    ...
    const struct Chord chord_200 PROGMEM = {H_TOP5, GAME, &state_200, NULL, KC_P, 0, single_dance};
    ...
    const struct Chord chord_201 PROGMEM = {H_TOP6, GAME, &state_201, NULL, KC_G, 0, single_dance};
    ...
    const struct Chord chord_202 PROGMEM = {H_TOP7, GAME, &state_202, NULL, KC_J, 0, single_dance};
    ...
    const struct Chord chord_203 PROGMEM = {H_TOP8, GAME, &state_203, NULL, KC_L, 0, single_dance};
    ...
    const struct Chord chord_204 PROGMEM = {H_TOP9, GAME, &state_204, NULL, KC_U, 0, single_dance};
    ...
    const struct Chord chord_205 PROGMEM = {H_TOP10, GAME, &state_205, NULL, KC_Y, 0, single_dance};
    ...
    const struct Chord chord_206 PROGMEM = {H_TOP11, GAME, &state_206, NULL, KC_SCOLON, 0, single_dance};
    ...
    const struct Chord chord_207 PROGMEM = {H_TOP12, GAME, &state_207, NULL, KC_RCTL, 0, single_dance};
    ...
    const struct Chord chord_208 PROGMEM = {H_TOP1 + H_BOT1, GAME, &state_208, NULL, KC_ESC, 0, single_dance};
    ...
    const struct Chord chord_209 PROGMEM = {H_TOP2 + H_BOT2, GAME, &state_209, NULL, KC_A, 0, single_dance};
    ...
    const struct Chord chord_210 PROGMEM = {H_TOP3 + H_BOT3, GAME, &state_210, NULL, KC_R, 0, single_dance};
    ...
    const struct Chord chord_211 PROGMEM = {H_TOP4 + H_BOT4, GAME, &state_211, NULL, KC_S, 0, single_dance};
    ...
    const struct Chord chord_212 PROGMEM = {H_TOP5 + H_BOT5, GAME, &state_212, NULL, KC_T, 0, single_dance};
    ...
    const struct Chord chord_213 PROGMEM = {H_TOP6 + H_BOT6, GAME, &state_213, NULL, KC_D, 0, single_dance};
    ...
    const struct Chord chord_214 PROGMEM = {H_TOP7 + H_BOT7, GAME, &state_214, NULL, KC_H, 0, single_dance};
    ...
    const struct Chord chord_215 PROGMEM = {H_TOP8 + H_BOT8, GAME, &state_215, NULL, KC_N, 0, single_dance};
    ...
    const struct Chord chord_216 PROGMEM = {H_TOP9 + H_BOT9, GAME, &state_216, NULL, KC_E, 0, single_dance};
    ...
    const struct Chord chord_217 PROGMEM = {H_TOP10 + H_BOT10, GAME, &state_217, NULL, KC_I, 0, single_dance};
    ...
    const struct Chord chord_218 PROGMEM = {H_TOP11 + H_BOT11, GAME, &state_218, NULL, KC_O, 0, single_dance};
    ...
    const struct Chord chord_219 PROGMEM = {H_TOP12 + H_BOT12, GAME, &state_219, NULL, COLEMAK, 0, perm_pseudolayer};
    ...
    const struct Chord chord_220 PROGMEM = {H_BOT1, GAME, &state_220, NULL, KC_LSFT, 0, single_dance};
    ...
    const struct Chord chord_221 PROGMEM = {H_BOT2, GAME, &state_221, NULL, KC_Z, 0, single_dance};
    ...
    const struct Chord chord_222 PROGMEM = {H_BOT3, GAME, &state_222, NULL, KC_X, 0, single_dance};
    ...
    const struct Chord chord_223 PROGMEM = {H_BOT4, GAME, &state_223, NULL, KC_C, 0, single_dance};
    ...
    const struct Chord chord_224 PROGMEM = {H_BOT5, GAME, &state_224, NULL, KC_V, 0, single_dance};
    ...
    const struct Chord chord_225 PROGMEM = {H_BOT6, GAME, &state_225, NULL, KC_B, 0, single_dance};
    ...
    const struct Chord chord_226 PROGMEM = {H_BOT7, GAME, &state_226, NULL, KC_K, 0, single_dance};
    ...
    const struct Chord chord_227 PROGMEM = {H_BOT8, GAME, &state_227, NULL, KC_M, 0, single_dance};
    ...
    const struct Chord chord_228 PROGMEM = {H_BOT9, GAME, &state_228, NULL, KC_COMMA, 0, single_dance};
    ...
    const struct Chord chord_229 PROGMEM = {H_BOT10, GAME, &state_229, NULL, KC_DOT, 0, single_dance};
    ...
    const struct Chord chord_230 PROGMEM = {H_BOT11, GAME, &state_230, NULL, KC_SLASH, 0, single_dance};
    ...
    const struct Chord chord_231 PROGMEM = {H_BOT12, GAME, &state_231, NULL, KC_DEL, 0, single_dance};
    ...
    const struct Chord chord_232 PROGMEM = {H_THU1, GAME, &state_232, NULL, NUM, 0, temp_pseudolayer};
    ...
    const struct Chord chord_233 PROGMEM = {H_THU2, GAME, &state_233, NULL, KC_SPC, 0, single_dance};
    ...
    const struct Chord chord_234 PROGMEM = {H_THU3, GAME, &state_234, NULL, KC_LSFT, 0, single_dance};
    ...
    const struct Chord chord_235 PROGMEM = {H_THU4, GAME, &state_235, NULL, KC_ENTER, KC_RSFT, key_key_dance};
    ...
    const struct Chord chord_236 PROGMEM = {H_THU5, GAME, &state_236, NULL, KC_SPC, NUM, key_layer_dance};
    ...
    const struct Chord chord_237 PROGMEM = {H_THU6, GAME, &state_237, NULL, KC_BSPC, SYM, key_layer_dance};
    ...
    const struct Chord chord_238 PROGMEM = {H_TOP1, STENO, &state_238, NULL, COLEMAK, 0, perm_pseudolayer};
