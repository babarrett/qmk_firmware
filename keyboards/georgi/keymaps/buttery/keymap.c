...
// Add all chords
    ...
    const struct Chord chord_77 PROGMEM = {H_TOP1 + H_BOT1, NUM, &state_77, NULL, KC_EQL, 0, single_dance};
    ...
    const struct Chord chord_78 PROGMEM = {H_TOP2 + H_BOT2, NUM, &state_78, NULL, KC_PLUS, 0, single_dance};
    ...
    const struct Chord chord_79 PROGMEM = {H_TOP3 + H_BOT3, NUM, &state_79, NULL, KC_MINS, 0, single_dance};
    ...
    const struct Chord chord_80 PROGMEM = {H_TOP4 + H_BOT4, NUM, &state_80, NULL, KC_ASTR, 0, single_dance};
    ...
    const struct Chord chord_81 PROGMEM = {H_TOP5 + H_BOT5, NUM, &state_81, NULL, KC_SLASH, 0, single_dance};
    ...
    const struct Chord chord_82 PROGMEM = {H_TOP6 + H_BOT6, NUM, &state_82, NULL, KC_DOT, 0, single_dance};
    ...
    const struct Chord chord_83 PROGMEM = {H_TOP7 + H_BOT7, NUM, &state_83, NULL, KC_COMMA, 0, single_dance};
    ...
    const struct Chord chord_84 PROGMEM = {H_TOP8 + H_BOT8, NUM, &state_84, NULL, KC_SLASH, 0, single_dance};
    ...
    const struct Chord chord_85 PROGMEM = {H_TOP9 + H_BOT9, NUM, &state_85, NULL, KC_ASTR, 0, single_dance};
    ...
    const struct Chord chord_86 PROGMEM = {H_TOP10 + H_BOT10, NUM, &state_86, NULL, KC_MINS, 0, single_dance};
    ...
    const struct Chord chord_87 PROGMEM = {H_TOP11 + H_BOT11, NUM, &state_87, NULL, KC_PLUS, 0, single_dance};
    ...
    const struct Chord chord_88 PROGMEM = {H_TOP12 + H_BOT12, NUM, &state_88, NULL, KC_EQL, 0, single_dance};
    ...
    const struct Chord chord_89 PROGMEM = {H_BOT1, NUM, &state_89, NULL, KC_LSFT, 0, single_dance};
    ...
    const struct Chord chord_90 PROGMEM = {H_BOT2, NUM, &state_90, NULL, KC_F1, 0, single_dance};
    ...
    const struct Chord chord_91 PROGMEM = {H_BOT3, NUM, &state_91, NULL, KC_F2, 0, single_dance};
    ...
    const struct Chord chord_92 PROGMEM = {H_BOT4, NUM, &state_92, NULL, KC_F3, 0, single_dance};
    ...
    const struct Chord chord_93 PROGMEM = {H_BOT5, NUM, &state_93, NULL, KC_F4, 0, single_dance};
    ...
    const struct Chord chord_94 PROGMEM = {H_BOT6, NUM, &state_94, NULL, KC_F5, 0, single_dance};
    ...
    const struct Chord chord_95 PROGMEM = {H_BOT7, NUM, &state_95, NULL, KC_F6, 0, single_dance};
    ...
    const struct Chord chord_96 PROGMEM = {H_BOT8, NUM, &state_96, NULL, KC_F7, 0, single_dance};
    ...
    const struct Chord chord_97 PROGMEM = {H_BOT9, NUM, &state_97, NULL, KC_F8, 0, single_dance};
    ...
    const struct Chord chord_98 PROGMEM = {H_BOT10, NUM, &state_98, NULL, KC_F9, 0, single_dance};
    ...
    const struct Chord chord_99 PROGMEM = {H_BOT11, NUM, &state_99, NULL, KC_F10, 0, single_dance};
    ...
    const struct Chord chord_100 PROGMEM = {H_BOT12, NUM, &state_100, NULL, KC_RSFT, 0, single_dance};
    ...
    const struct Chord chord_101 PROGMEM = {H_THU1, NUM, &state_101, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_102 PROGMEM = {H_THU2, NUM, &state_102, NULL, KC_SPC, 0, single_dance};
    ...
    const struct Chord chord_103 PROGMEM = {H_THU3, NUM, &state_103, NULL, KC_RSFT, 0, single_dance};
    ...
    const struct Chord chord_104 PROGMEM = {H_THU4, NUM, &state_104, NULL, KC_ENTER, 0, single_dance};
    ...
    const struct Chord chord_105 PROGMEM = {H_THU5, NUM, &state_105, NULL, KC_SPC, 0, single_dance};
    ...
    const struct Chord chord_106 PROGMEM = {H_THU6, NUM, &state_106, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_107 PROGMEM = {H_BOT2 + H_BOT3, NUM, &state_107, NULL, KC_F11, 0, single_dance};
    ...
    const struct Chord chord_108 PROGMEM = {H_BOT3 + H_BOT4, NUM, &state_108, NULL, KC_LALT, 0, single_dance};
    ...
    const struct Chord chord_109 PROGMEM = {H_BOT4 + H_BOT5, NUM, &state_109, NULL, KC_LGUI, 0, single_dance};
    ...
    const struct Chord chord_110 PROGMEM = {H_BOT5 + H_BOT6, NUM, &state_110, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_111 PROGMEM = {H_BOT7 + H_BOT8, NUM, &state_111, NULL, KC_RCTL, 0, single_dance};
    ...
    const struct Chord chord_112 PROGMEM = {H_BOT8 + H_BOT9, NUM, &state_112, NULL, KC_RGUI, 0, single_dance};
    ...
    const struct Chord chord_113 PROGMEM = {H_BOT9 + H_BOT10, NUM, &state_113, NULL, KC_RALT, 0, single_dance};
    ...
    const struct Chord chord_114 PROGMEM = {H_BOT10 + H_BOT11, NUM, &state_114, NULL, KC_F12, 0, single_dance};
    ...
    const struct Chord chord_115 PROGMEM = {H_BOT7 + H_BOT8 + H_BOT9 + H_BOT10, NUM, &state_115, &counter_115, 0, 0, function_115};
    ...
    void function_116(const struct Chord* self) {
        switch (*self->state) {
            case ACTIVATED:
    ...
    uint8_t counter_116 = 0;
    const struct Chord chord_116 PROGMEM = {H_BOT3 + H_BOT4 + H_BOT5 + H_BOT6, NUM, &state_116, &counter_116, 0, 0, function_116};
    ...
    const struct Chord chord_117 PROGMEM = {H_TOP2, SYM, &state_117, NULL, KC_GRV, 0, single_dance};
    ...
    const struct Chord chord_118 PROGMEM = {H_TOP3, SYM, &state_118, NULL, KC_LBRC, 0, single_dance};
    ...
    const struct Chord chord_119 PROGMEM = {H_TOP4, SYM, &state_119, NULL, KC_LCBR, 0, single_dance};
    ...
    const struct Chord chord_120 PROGMEM = {H_TOP5, SYM, &state_120, NULL, KC_LPRN, 0, single_dance};
    ...
    const struct Chord chord_121 PROGMEM = {H_TOP6, SYM, &state_121, NULL, KC_LABK, 0, single_dance};
    ...
    const struct Chord chord_122 PROGMEM = {H_TOP7, SYM, &state_122, NULL, KC_RABK, 0, single_dance};
    ...
    const struct Chord chord_123 PROGMEM = {H_TOP8, SYM, &state_123, NULL, KC_RPRN, 0, single_dance};
    ...
    const struct Chord chord_124 PROGMEM = {H_TOP9, SYM, &state_124, NULL, KC_RCBR, 0, single_dance};
    ...
    const struct Chord chord_125 PROGMEM = {H_TOP10, SYM, &state_125, NULL, KC_RBRC, 0, single_dance};
    ...
    const struct Chord chord_126 PROGMEM = {H_TOP11, SYM, &state_126, NULL, KC_QUES, 0, single_dance};
    ...
    const struct Chord chord_127 PROGMEM = {H_TOP12, SYM, &state_127, NULL, KC_RCTL, 0, single_dance};
    ...
    const struct Chord chord_128 PROGMEM = {H_TOP2 + H_BOT2, SYM, &state_128, NULL, KC_TILDE, 0, single_dance};
    ...
    const struct Chord chord_129 PROGMEM = {H_TOP3 + H_BOT3, SYM, &state_129, NULL, KC_MINS, 0, single_dance};
    ...
    const struct Chord chord_130 PROGMEM = {H_TOP4 + H_BOT4, SYM, &state_130, NULL, KC_QUOT, 0, single_dance};
    ...
    const struct Chord chord_131 PROGMEM = {H_TOP5 + H_BOT5, SYM, &state_131, NULL, KC_COLN, 0, single_dance};
    ...
    const struct Chord chord_132 PROGMEM = {H_TOP6 + H_BOT6, SYM, &state_132, NULL, KC_UNDS, 0, single_dance};
    ...
    const struct Chord chord_133 PROGMEM = {H_TOP7 + H_BOT7, SYM, &state_133, NULL, KC_BSLS, 0, single_dance};
    ...
    const struct Chord chord_134 PROGMEM = {H_TOP8 + H_BOT8, SYM, &state_134, NULL, KC_EQL, 0, single_dance};
    ...
    const struct Chord chord_135 PROGMEM = {H_TOP9 + H_BOT9, SYM, &state_135, NULL, KC_DQUO, 0, single_dance};
    ...
    const struct Chord chord_136 PROGMEM = {H_TOP10 + H_BOT10, SYM, &state_136, NULL, KC_PLUS, 0, single_dance};
    ...
    const struct Chord chord_137 PROGMEM = {H_TOP11 + H_BOT11, SYM, &state_137, NULL, KC_BSLS, 0, single_dance};
    ...
    const struct Chord chord_138 PROGMEM = {H_TOP12 + H_BOT12, SYM, &state_138, NULL, KC_RGUI, 0, single_dance};
    ...
    const struct Chord chord_139 PROGMEM = {H_BOT2, SYM, &state_139, NULL, KC_EXLM, 0, single_dance};
    ...
    const struct Chord chord_140 PROGMEM = {H_BOT3, SYM, &state_140, NULL, KC_AT, 0, single_dance};
    ...
    const struct Chord chord_141 PROGMEM = {H_BOT4, SYM, &state_141, NULL, KC_HASH, 0, single_dance};
    ...
    const struct Chord chord_142 PROGMEM = {H_BOT5, SYM, &state_142, NULL, KC_DLR, 0, single_dance};
    ...
    const struct Chord chord_143 PROGMEM = {H_BOT6, SYM, &state_143, NULL, KC_PERC, 0, single_dance};
    ...
    const struct Chord chord_144 PROGMEM = {H_BOT7, SYM, &state_144, NULL, KC_CIRC, 0, single_dance};
    ...
    const struct Chord chord_145 PROGMEM = {H_BOT8, SYM, &state_145, NULL, KC_AMPR, 0, single_dance};
    ...
    const struct Chord chord_146 PROGMEM = {H_BOT9, SYM, &state_146, NULL, KC_ASTR, 0, single_dance};
    ...
    const struct Chord chord_147 PROGMEM = {H_BOT10, SYM, &state_147, NULL, KC_PIPE, 0, single_dance};
    ...
    const struct Chord chord_148 PROGMEM = {H_BOT11, SYM, &state_148, NULL, KC_QUES, 0, single_dance};
    ...
    const struct Chord chord_149 PROGMEM = {H_BOT12, SYM, &state_149, NULL, KC_RALT, 0, single_dance};
    ...
    const struct Chord chord_150 PROGMEM = {H_THU1, SYM, &state_150, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_151 PROGMEM = {H_THU2, SYM, &state_151, NULL, KC_SPACE, 0, single_dance};
    ...
    const struct Chord chord_152 PROGMEM = {H_THU5, SYM, &state_152, NULL, KC_SPACE, 0, single_dance};
    ...
    const struct Chord chord_153 PROGMEM = {H_THU6, SYM, &state_153, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_154 PROGMEM = {H_BOT3 + H_BOT4, SYM, &state_154, NULL, KC_LALT, 0, single_dance};
    ...
    const struct Chord chord_155 PROGMEM = {H_BOT4 + H_BOT5, SYM, &state_155, NULL, KC_LGUI, 0, single_dance};
    ...
    const struct Chord chord_156 PROGMEM = {H_BOT5 + H_BOT6, SYM, &state_156, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_157 PROGMEM = {H_BOT7 + H_BOT8, SYM, &state_157, NULL, KC_RCTL, 0, single_dance};
    ...
    const struct Chord chord_158 PROGMEM = {H_BOT8 + H_BOT9, SYM, &state_158, NULL, KC_RGUI, 0, single_dance};
    ...
    const struct Chord chord_159 PROGMEM = {H_BOT9 + H_BOT10, SYM, &state_159, NULL, KC_RALT, 0, single_dance};
    ...
    void function_160(const struct Chord* self) {
        switch (*self->state) {
            case ACTIVATED:
    ...
    const struct Chord chord_160 PROGMEM = {H_TOP2, MOVE, &state_160, &counter_160, 0, 0, function_160};
    ...
    const struct Chord chord_161 PROGMEM = {H_TOP3, MOVE, &state_161, NULL, KC_HOME, 0, single_dance};
    ...
    const struct Chord chord_162 PROGMEM = {H_TOP4, MOVE, &state_162, NULL, KC_UP, 0, single_dance};
    ...
    const struct Chord chord_163 PROGMEM = {H_TOP5, MOVE, &state_163, NULL, KC_PGUP, 0, single_dance};
    ...
    const struct Chord chord_164 PROGMEM = {H_TOP6, MOVE, &state_164, &counter_164, 0, 0, function_164};
    ...
    const struct Chord chord_165 PROGMEM = {H_TOP9, MOVE, &state_165, NULL, KC_UP, 0, single_dance};
    ...
    const struct Chord chord_166 PROGMEM = {H_TOP1 + H_BOT1, MOVE, &state_166, NULL, KC_INS, 0, single_dance};
    ...
    const struct Chord chord_167 PROGMEM = {H_TOP2 + H_BOT2, MOVE, &state_167, &counter_167, 0, 0, function_167};
    ...
    const struct Chord chord_168 PROGMEM = {H_TOP3 + H_BOT3, MOVE, &state_168, NULL, KC_END, 0, single_dance};
    ...
    const struct Chord chord_169 PROGMEM = {H_TOP5 + H_BOT5, MOVE, &state_169, NULL, KC_PGDN, 0, single_dance};
    ...
    const struct Chord chord_170 PROGMEM = {H_TOP6 + H_BOT6, MOVE, &state_170, &counter_170, 0, 0, function_170};
    ...
    const struct Chord chord_171 PROGMEM = {H_TOP8 + H_BOT8, MOVE, &state_171, NULL, KC_LEFT, 0, single_dance};
    ...
    const struct Chord chord_172 PROGMEM = {H_TOP9 + H_BOT9, MOVE, &state_172, NULL, KC_DOWN, 0, single_dance};
    ...
    const struct Chord chord_173 PROGMEM = {H_TOP10 + H_BOT10, MOVE, &state_173, NULL, KC_RIGHT, 0, single_dance};
    ...
    const struct Chord chord_174 PROGMEM = {H_BOT1, MOVE, &state_174, NULL, KC_LSFT, 0, single_dance};
    ...
    void function_175(const struct Chord* self) {
        switch (*self->state) {
            case ACTIVATED:
    ...
    const struct Chord chord_175 PROGMEM = {H_BOT2, MOVE, &state_175, &counter_175, 0, 0, function_175};
    ...
    const struct Chord chord_176 PROGMEM = {H_BOT3, MOVE, &state_176, NULL, KC_LEFT, 0, single_dance};
    ...
    const struct Chord chord_177 PROGMEM = {H_BOT4, MOVE, &state_177, NULL, KC_DOWN, 0, single_dance};
    ...
    const struct Chord chord_178 PROGMEM = {H_BOT5, MOVE, &state_178, NULL, KC_RIGHT, 0, single_dance};
    ...
    void function_179(const struct Chord* self) {
        switch (*self->state) {
            case ACTIVATED:
    ...
    uint8_t counter_179 = 0;
    const struct Chord chord_179 PROGMEM = {H_BOT6, MOVE, &state_179, &counter_179, 0, 0, function_179};
    ...
    const struct Chord chord_180 PROGMEM = {H_BOT8, MOVE, &state_180, NULL, KC_LEFT, 0, single_dance};
    ...
    const struct Chord chord_181 PROGMEM = {H_BOT9, MOVE, &state_181, NULL, KC_DOWN, 0, single_dance};
    ...
    const struct Chord chord_182 PROGMEM = {H_BOT10, MOVE, &state_182, NULL, KC_RIGHT, 0, single_dance};
    ...
    const struct Chord chord_183 PROGMEM = {H_BOT12, MOVE, &state_183, NULL, KC_RSFT, 0, single_dance};
    ...
    const struct Chord chord_184 PROGMEM = {H_BOT3 + H_BOT4, MOVE, &state_184, NULL, KC_LALT, 0, single_dance};
    ...
    const struct Chord chord_185 PROGMEM = {H_BOT4 + H_BOT5, MOVE, &state_185, NULL, KC_LGUI, 0, single_dance};
    ...
    const struct Chord chord_186 PROGMEM = {H_BOT5 + H_BOT6, MOVE, &state_186, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_187 PROGMEM = {H_BOT7 + H_BOT8, MOVE, &state_187, NULL, KC_RCTL, 0, single_dance};
    ...
    const struct Chord chord_188 PROGMEM = {H_BOT8 + H_BOT9, MOVE, &state_188, NULL, KC_RGUI, 0, single_dance};
    ...
    const struct Chord chord_189 PROGMEM = {H_BOT9 + H_BOT10, MOVE, &state_189, NULL, KC_RALT, 0, single_dance};
    ...
    const struct Chord chord_190 PROGMEM = {H_TOP8, MEDIA, &state_190, NULL, KC_MPRV, 0, single_dance};
    ...
    const struct Chord chord_191 PROGMEM = {H_TOP9, MEDIA, &state_191, NULL, KC_MPLY, 0, single_dance};
    ...
    const struct Chord chord_192 PROGMEM = {H_TOP10, MEDIA, &state_192, NULL, KC_MPLY, 0, single_dance};
    ...
    const struct Chord chord_193 PROGMEM = {H_TOP11, MEDIA, &state_193, NULL, KC_MNXT, 0, single_dance};
    ...
    const struct Chord chord_194 PROGMEM = {H_TOP12, MEDIA, &state_194, NULL, KC_VOLU, 0, single_dance};
    ...
    const struct Chord chord_195 PROGMEM = {H_TOP12 + H_BOT12, MEDIA, &state_195, NULL, KC_MUTE, 0, single_dance};
    ...
    const struct Chord chord_196 PROGMEM = {H_BOT12, MEDIA, &state_196, NULL, KC_VOLD, 0, single_dance};
    ...
    const struct Chord chord_197 PROGMEM = {H_TOP1, GAME, &state_197, NULL, KC_TAB, 0, single_dance};
    ...
    const struct Chord chord_198 PROGMEM = {H_TOP2, GAME, &state_198, NULL, KC_Q, 0, single_dance};
    ...
    const struct Chord chord_199 PROGMEM = {H_TOP3, GAME, &state_199, NULL, KC_W, 0, single_dance};
    ...
    const struct Chord chord_200 PROGMEM = {H_TOP4, GAME, &state_200, NULL, KC_F, 0, single_dance};
    ...
    const struct Chord chord_201 PROGMEM = {H_TOP5, GAME, &state_201, NULL, KC_P, 0, single_dance};
    ...
    const struct Chord chord_202 PROGMEM = {H_TOP6, GAME, &state_202, NULL, KC_G, 0, single_dance};
    ...
    const struct Chord chord_203 PROGMEM = {H_TOP7, GAME, &state_203, NULL, KC_J, 0, single_dance};
    ...
    const struct Chord chord_204 PROGMEM = {H_TOP8, GAME, &state_204, NULL, KC_L, 0, single_dance};
    ...
    const struct Chord chord_205 PROGMEM = {H_TOP9, GAME, &state_205, NULL, KC_U, 0, single_dance};
    ...
    const struct Chord chord_206 PROGMEM = {H_TOP10, GAME, &state_206, NULL, KC_Y, 0, single_dance};
    ...
    const struct Chord chord_207 PROGMEM = {H_TOP11, GAME, &state_207, NULL, KC_SCOLON, 0, single_dance};
    ...
    const struct Chord chord_208 PROGMEM = {H_TOP12, GAME, &state_208, NULL, KC_RCTL, 0, single_dance};
    ...
    const struct Chord chord_209 PROGMEM = {H_TOP1 + H_BOT1, GAME, &state_209, NULL, KC_ESC, 0, single_dance};
