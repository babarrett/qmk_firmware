...
// Add all chords
    ...
    const struct Chord chord_96 PROGMEM = {H_TOP12, SYM, &state_96, NULL, KC_RCTL, 0, single_dance};
    ...
    const struct Chord chord_121 PROGMEM = {H_BOT5 + H_BOT6, SYM, &state_121, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_122 PROGMEM = {H_BOT7 + H_BOT8, SYM, &state_122, NULL, KC_RCTL, 0, single_dance};
    ...
    const struct Chord chord_128 PROGMEM = {H_TOP1 + H_BOT1, MOVE, &state_128, NULL, KC_INS, 0, single_dance};
    ...
    const struct Chord chord_130 PROGMEM = {H_TOP5 + H_BOT5, MOVE, &state_130, NULL, KC_PGDN, 0, single_dance};
    ...
    const struct Chord chord_131 PROGMEM = {H_BOT1, MOVE, &state_131, NULL, KC_LSFT, 0, single_dance};
    ...
    const struct Chord chord_135 PROGMEM = {H_BOT12, MOVE, &state_135, NULL, KC_RSFT, 0, single_dance};
    ...
    const struct Chord chord_138 PROGMEM = {H_BOT5 + H_BOT6, MOVE, &state_138, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_139 PROGMEM = {H_BOT7 + H_BOT8, MOVE, &state_139, NULL, KC_RCTL, 0, single_dance};
