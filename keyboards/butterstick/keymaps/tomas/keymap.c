...
// Add all chords
    ...
    const struct Chord chord_2 PROGMEM = {H_TOP5 + H_BOT5 + H_TOP6 + H_BOT6, ALWAYS_ON, &state_2, NULL, 0, 0, command};
    ...
    const struct Chord chord_41 PROGMEM = {H_TOP9 + H_BOT9 + H_TOP0 + H_BOT0, QWERTY, &state_41, NULL, KC_ENTER, 0, single_dance};
    ...
    const struct Chord chord_53 PROGMEM = {H_TOP1, NUM, &state_53, &counter_53, KC_1, 0, autoshift_dance};
    ...
    const struct Chord chord_54 PROGMEM = {H_TOP2, NUM, &state_54, &counter_54, KC_2, 0, autoshift_dance};
    ...
    const struct Chord chord_55 PROGMEM = {H_TOP3, NUM, &state_55, &counter_55, KC_3, 0, autoshift_dance};
    ...
    const struct Chord chord_56 PROGMEM = {H_TOP4, NUM, &state_56, &counter_56, KC_4, 0, autoshift_dance};
    ...
    const struct Chord chord_57 PROGMEM = {H_TOP5, NUM, &state_57, &counter_57, KC_5, 0, autoshift_dance};
    ...
    const struct Chord chord_58 PROGMEM = {H_TOP6, NUM, &state_58, &counter_58, KC_6, 0, autoshift_dance};
    ...
    const struct Chord chord_59 PROGMEM = {H_TOP7, NUM, &state_59, &counter_59, KC_7, 0, autoshift_dance};
    ...
    const struct Chord chord_60 PROGMEM = {H_TOP8, NUM, &state_60, &counter_60, KC_8, 0, autoshift_dance};
    ...
    const struct Chord chord_61 PROGMEM = {H_TOP9, NUM, &state_61, &counter_61, KC_9, 0, autoshift_dance};
    ...
    const struct Chord chord_62 PROGMEM = {H_TOP0, NUM, &state_62, &counter_62, KC_0, 0, autoshift_dance};
    ...
    const struct Chord chord_63 PROGMEM = {H_TOP1 + H_BOT1, NUM, &state_63, NULL, KC_F1, 0, single_dance};
    ...
    const struct Chord chord_64 PROGMEM = {H_TOP2 + H_BOT2, NUM, &state_64, NULL, KC_F2, 0, single_dance};
    ...
    const struct Chord chord_65 PROGMEM = {H_TOP3 + H_BOT3, NUM, &state_65, NULL, KC_F3, 0, single_dance};
    ...
    const struct Chord chord_66 PROGMEM = {H_TOP4 + H_BOT4, NUM, &state_66, NULL, KC_F4, 0, single_dance};
    ...
    const struct Chord chord_67 PROGMEM = {H_TOP5 + H_BOT5, NUM, &state_67, NULL, KC_F5, 0, single_dance};
    ...
    const struct Chord chord_68 PROGMEM = {H_TOP6 + H_BOT6, NUM, &state_68, NULL, KC_F6, 0, single_dance};
    ...
    const struct Chord chord_69 PROGMEM = {H_TOP7 + H_BOT7, NUM, &state_69, NULL, KC_F7, 0, single_dance};
    ...
    const struct Chord chord_70 PROGMEM = {H_TOP8 + H_BOT8, NUM, &state_70, NULL, KC_F8, 0, single_dance};
    ...
    const struct Chord chord_71 PROGMEM = {H_TOP9 + H_BOT9, NUM, &state_71, NULL, KC_F9, 0, single_dance};
    ...
    const struct Chord chord_72 PROGMEM = {H_TOP0 + H_BOT0, NUM, &state_72, NULL, KC_F10, 0, single_dance};
    ...
    const struct Chord chord_73 PROGMEM = {H_BOT1, NUM, &state_73, &counter_73, KC_GRAVE, 0, autoshift_dance};
    ...
    const struct Chord chord_74 PROGMEM = {H_BOT2, NUM, &state_74, &counter_74, KC_MINUS, 0, autoshift_dance};
    ...
    const struct Chord chord_75 PROGMEM = {H_BOT3, NUM, &state_75, &counter_75, KC_EQUAL, 0, autoshift_dance};
    ...
    const struct Chord chord_76 PROGMEM = {H_BOT4, NUM, &state_76, &counter_76, KC_LBRACKET, 0, autoshift_dance};
    ...
    const struct Chord chord_77 PROGMEM = {H_BOT5, NUM, &state_77, &counter_77, KC_RBRACKET, 0, autoshift_dance};
    ...
    const struct Chord chord_78 PROGMEM = {H_BOT6, NUM, &state_78, &counter_78, KC_BSLASH, 0, autoshift_dance};
    ...
    const struct Chord chord_79 PROGMEM = {H_BOT7, NUM, &state_79, &counter_79, KC_QUOTE, 0, autoshift_dance};
    ...
    const struct Chord chord_82 PROGMEM = {H_TOP1 + H_TOP2, NUM, &state_82, NULL, KC_ESC, 0, single_dance};
    ...
    const struct Chord chord_83 PROGMEM = {H_TOP3 + H_TOP4, NUM, &state_83, NULL, KC_TAB, 0, single_dance};
    ...
    const struct Chord chord_84 PROGMEM = {H_TOP5 + H_TOP6, NUM, &state_84, NULL, KC_RGUI, 0, one_shot_key};
    ...
    const struct Chord chord_85 PROGMEM = {H_TOP7 + H_TOP8, NUM, &state_85, NULL, KC_INS, 0, single_dance};
    ...
    const struct Chord chord_86 PROGMEM = {H_TOP8 + H_TOP9, NUM, &state_86, NULL, KC_DEL, 0, single_dance};
    ...
    const struct Chord chord_87 PROGMEM = {H_TOP9 + H_TOP0, NUM, &state_87, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_88 PROGMEM = {H_TOP9 + H_BOT9 + H_TOP0 + H_BOT0, NUM, &state_88, NULL, KC_ENTER, 0, single_dance};
    ...
    const struct Chord chord_89 PROGMEM = {H_BOT1 + H_BOT2, NUM, &state_89, NULL, KC_LSFT, 0, one_shot_key};
    ...
    const struct Chord chord_90 PROGMEM = {H_BOT2 + H_BOT3, NUM, &state_90, NULL, KC_LCTL, 0, one_shot_key};
    ...
    const struct Chord chord_91 PROGMEM = {H_BOT3 + H_BOT4, NUM, &state_91, NULL, KC_LALT, 0, one_shot_key};
    ...
    const struct Chord chord_92 PROGMEM = {H_BOT5 + H_BOT6, NUM, &state_92, NULL, KC_LGUI, 0, one_shot_key};
    ...
    const struct Chord chord_93 PROGMEM = {H_BOT7 + H_BOT8, NUM, &state_93, NULL, KC_RALT, 0, one_shot_key};
    ...
    const struct Chord chord_94 PROGMEM = {H_BOT8 + H_BOT9, NUM, &state_94, NULL, KC_RCTL, 0, one_shot_key};
    ...
    const struct Chord chord_95 PROGMEM = {H_BOT9 + H_BOT0, NUM, &state_95, NULL, KC_RSFT, 0, one_shot_key};
    ...
    const struct Chord chord_96 PROGMEM = {H_BOT1 + H_BOT0, NUM, &state_96, NULL, KC_SPACE, 0, single_dance};
    ...
    const struct Chord chord_109 PROGMEM = {H_TOP7, MOUSE, &state_109, NULL, KC_BTN1, 0, single_dance};
    ...
    const struct Chord chord_110 PROGMEM = {H_TOP8, MOUSE, &state_110, NULL, KC_MS_U, 0, single_dance};
    ...
    const struct Chord chord_111 PROGMEM = {H_TOP9, MOUSE, &state_111, NULL, KC_BTN2, 0, single_dance};
    ...
    const struct Chord chord_112 PROGMEM = {H_TOP0, MOUSE, &state_112, NULL, KC_WH_U, 0, single_dance};
    ...
    const struct Chord chord_113 PROGMEM = {H_BOT3, MOUSE, &state_113, NULL, KC_LSFT, 0, single_dance};
    ...
    const struct Chord chord_114 PROGMEM = {H_BOT4, MOUSE, &state_114, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_115 PROGMEM = {H_BOT5, MOUSE, &state_115, NULL, KC_LALT, 0, single_dance};
    ...
    const struct Chord chord_116 PROGMEM = {H_BOT6, MOUSE, &state_116, NULL, KC_LGUI, 0, single_dance};
    ...
    const struct Chord chord_117 PROGMEM = {H_BOT7, MOUSE, &state_117, NULL, KC_MS_L, 0, single_dance};
    ...
    const struct Chord chord_118 PROGMEM = {H_BOT8, MOUSE, &state_118, NULL, KC_MS_D, 0, single_dance};
    ...
    const struct Chord chord_119 PROGMEM = {H_BOT9, MOUSE, &state_119, NULL, KC_MS_R, 0, single_dance};
    ...
    const struct Chord chord_120 PROGMEM = {H_BOT0, MOUSE, &state_120, NULL, KC_WH_D, 0, single_dance};
    ...
    const struct Chord chord_121 PROGMEM = {H_TOP1 + H_TOP0 + H_BOT1 + H_BOT0, QWERTY, &state_121, NULL, ASETNIOP, 0, perm_pseudolayer};
    ...
    const struct Chord chord_122 PROGMEM = {H_TOP1 + H_TOP0 + H_BOT1 + H_BOT0, ASETNIOP, &state_122, NULL, QWERTY, 0, perm_pseudolayer};
    ...
    const struct Chord chord_123 PROGMEM = {H_BOT4 + H_BOT7, ASETNIOP, &state_123, NULL, ASETNIOP_FN, 0, temp_pseudolayer};
    ...
    const struct Chord chord_124 PROGMEM = {H_TOP1, ASETNIOP, &state_124, NULL, KC_A, 0, single_dance};
    ...
    const struct Chord chord_125 PROGMEM = {H_TOP2, ASETNIOP, &state_125, NULL, KC_S, 0, single_dance};
    ...
    const struct Chord chord_126 PROGMEM = {H_TOP3, ASETNIOP, &state_126, NULL, KC_E, 0, single_dance};
    ...
    const struct Chord chord_127 PROGMEM = {H_TOP4, ASETNIOP, &state_127, NULL, KC_T, 0, single_dance};
    ...
    const struct Chord chord_128 PROGMEM = {H_TOP7, ASETNIOP, &state_128, NULL, KC_N, 0, single_dance};
    ...
    const struct Chord chord_129 PROGMEM = {H_TOP8, ASETNIOP, &state_129, NULL, KC_I, 0, single_dance};
    ...
    const struct Chord chord_130 PROGMEM = {H_TOP9, ASETNIOP, &state_130, NULL, KC_O, 0, single_dance};
    ...
    const struct Chord chord_131 PROGMEM = {H_TOP0, ASETNIOP, &state_131, NULL, KC_P, 0, single_dance};
    ...
    const struct Chord chord_132 PROGMEM = {H_TOP1 + H_TOP2, ASETNIOP, &state_132, NULL, KC_W, 0, single_dance};
    ...
    const struct Chord chord_133 PROGMEM = {H_TOP2 + H_TOP3, ASETNIOP, &state_133, NULL, KC_D, 0, single_dance};
    ...
    const struct Chord chord_134 PROGMEM = {H_TOP3 + H_TOP4, ASETNIOP, &state_134, NULL, KC_R, 0, single_dance};
    ...
    const struct Chord chord_135 PROGMEM = {H_TOP4 + H_TOP7, ASETNIOP, &state_135, NULL, KC_B, 0, single_dance};
    ...
    const struct Chord chord_136 PROGMEM = {H_TOP7 + H_TOP8, ASETNIOP, &state_136, NULL, KC_H, 0, single_dance};
    ...
    const struct Chord chord_137 PROGMEM = {H_TOP8 + H_TOP9, ASETNIOP, &state_137, NULL, KC_L, 0, single_dance};
    ...
    const struct Chord chord_138 PROGMEM = {H_TOP9 + H_TOP0, ASETNIOP, &state_138, NULL, KC_SCOLON, 0, single_dance};
    ...
    const struct Chord chord_139 PROGMEM = {H_TOP1 + H_TOP3, ASETNIOP, &state_139, NULL, KC_X, 0, single_dance};
    ...
    const struct Chord chord_140 PROGMEM = {H_TOP2 + H_TOP4, ASETNIOP, &state_140, NULL, KC_C, 0, single_dance};
    ...
    const struct Chord chord_141 PROGMEM = {H_TOP3 + H_TOP7, ASETNIOP, &state_141, NULL, KC_Y, 0, single_dance};
    ...
    const struct Chord chord_142 PROGMEM = {H_TOP4 + H_TOP8, ASETNIOP, &state_142, NULL, KC_V, 0, single_dance};
    ...
    const struct Chord chord_143 PROGMEM = {H_TOP7 + H_TOP9, ASETNIOP, &state_143, NULL, KC_U, 0, single_dance};
    ...
    const struct Chord chord_144 PROGMEM = {H_TOP1 + H_TOP4, ASETNIOP, &state_144, NULL, KC_F, 0, single_dance};
    ...
    const struct Chord chord_145 PROGMEM = {H_TOP2 + H_TOP7, ASETNIOP, &state_145, NULL, KC_J, 0, single_dance};
    ...
    const struct Chord chord_146 PROGMEM = {H_TOP3 + H_TOP8, ASETNIOP, &state_146, NULL, KC_COMMA, 0, single_dance};
    ...
    const struct Chord chord_147 PROGMEM = {H_TOP4 + H_TOP9, ASETNIOP, &state_147, NULL, KC_G, 0, single_dance};
    ...
    const struct Chord chord_148 PROGMEM = {H_TOP7 + H_TOP0, ASETNIOP, &state_148, NULL, KC_M, 0, single_dance};
    ...
    const struct Chord chord_149 PROGMEM = {H_TOP1 + H_TOP7, ASETNIOP, &state_149, NULL, KC_Q, 0, single_dance};
    ...
    const struct Chord chord_150 PROGMEM = {H_TOP2 + H_TOP8, ASETNIOP, &state_150, NULL, KC_K, 0, single_dance};
    ...
    const struct Chord chord_151 PROGMEM = {H_TOP3 + H_TOP9, ASETNIOP, &state_151, NULL, KC_MINUS, 0, single_dance};
    ...
    const struct Chord chord_152 PROGMEM = {H_TOP4 + H_TOP0, ASETNIOP, &state_152, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_153 PROGMEM = {H_TOP1 + H_TOP8, ASETNIOP, &state_153, NULL, KC_Z, 0, single_dance};
    ...
    const struct Chord chord_154 PROGMEM = {H_TOP2 + H_TOP9, ASETNIOP, &state_154, NULL, KC_DOT, 0, single_dance};
    ...
    const struct Chord chord_155 PROGMEM = {H_TOP3 + H_TOP0, ASETNIOP, &state_155, NULL, KC_QUOTE, 0, single_dance};
    ...
    const struct Chord chord_156 PROGMEM = {H_TOP1 + H_TOP9, ASETNIOP, &state_156, NULL, KC_LBRACKET, 0, single_dance};
    ...
    const struct Chord chord_157 PROGMEM = {H_TOP2 + H_TOP0, ASETNIOP, &state_157, NULL, KC_RBRACKET, 0, single_dance};
    ...
    const struct Chord chord_158 PROGMEM = {H_TOP1 + H_TOP0, ASETNIOP, &state_158, NULL, KC_SLASH, 0, single_dance};
    ...
    const struct Chord chord_159 PROGMEM = {H_TOP5, ASETNIOP, &state_159, NULL, KC_ESC, 0, single_dance};
    ...
    const struct Chord chord_160 PROGMEM = {H_TOP6, ASETNIOP, &state_160, NULL, KC_DEL, 0, single_dance};
    ...
    const struct Chord chord_161 PROGMEM = {H_BOT4, ASETNIOP, &state_161, NULL, KC_LSFT, 0, single_dance};
    ...
    const struct Chord chord_162 PROGMEM = {H_BOT5, ASETNIOP, &state_162, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_163 PROGMEM = {H_BOT6, ASETNIOP, &state_163, NULL, KC_LALT, 0, single_dance};
    ...
    const struct Chord chord_164 PROGMEM = {H_BOT7, ASETNIOP, &state_164, NULL, KC_SPACE, ASETNIOP_123, key_layer_dance};
    ...
    const struct Chord chord_165 PROGMEM = {H_TOP5 + H_TOP6, ASETNIOP, &state_165, NULL, KC_LGUI, 0, single_dance};
