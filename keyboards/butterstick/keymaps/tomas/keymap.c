...
// Add all chords
    ...
    const struct Chord chord_1 PROGMEM = {H_TOP2 + H_BOT2 + H_TOP3 + H_BOT3, ALWAYS_ON, &state_1, NULL, 0, 0, autoshift_toggle};
    ...
    const struct Chord chord_2 PROGMEM = {H_TOP3 + H_BOT3 + H_TOP4 + H_BOT4, ALWAYS_ON, &state_2, NULL, 1, 0, switch_layer};
    ...
    const struct Chord chord_3 PROGMEM = {H_TOP5 + H_BOT5 + H_TOP6 + H_BOT6, ALWAYS_ON, &state_3, NULL, 0, 0, command};
    ...
    const struct Chord chord_4 PROGMEM = {H_TOP1 + H_TOP2 + H_TOP9 + H_TOP0 + H_BOT1 + H_BOT2 + H_BOT9 + H_BOT0, ALWAYS_ON, &state_4, NULL, 0, 0, clear};
    ...
    uint8_t counter_5 = 0;
    const struct Chord chord_5 PROGMEM = {H_TOP1, QWERTY, &state_5, &counter_5, KC_Q, 0, autoshift_dance};
    ...
    uint8_t counter_6 = 0;
    const struct Chord chord_6 PROGMEM = {H_TOP2, QWERTY, &state_6, &counter_6, KC_W, 0, autoshift_dance};
    ...
    uint8_t counter_7 = 0;
    const struct Chord chord_7 PROGMEM = {H_TOP3, QWERTY, &state_7, &counter_7, KC_E, 0, autoshift_dance};
    ...
    uint8_t counter_8 = 0;
    const struct Chord chord_8 PROGMEM = {H_TOP4, QWERTY, &state_8, &counter_8, KC_R, 0, autoshift_dance};
    ...
    uint8_t counter_9 = 0;
    const struct Chord chord_9 PROGMEM = {H_TOP5, QWERTY, &state_9, &counter_9, KC_T, 0, autoshift_dance};
    ...
    const struct Chord chord_10 PROGMEM = {H_TOP6, QWERTY, &state_10, &counter_10, KC_Y, 0, autoshift_dance};
    ...
    const struct Chord chord_11 PROGMEM = {H_TOP7, QWERTY, &state_11, &counter_11, KC_U, 0, autoshift_dance};
    ...
    const struct Chord chord_12 PROGMEM = {H_TOP8, QWERTY, &state_12, &counter_12, KC_I, 0, autoshift_dance};
    ...
    const struct Chord chord_13 PROGMEM = {H_TOP9, QWERTY, &state_13, &counter_13, KC_O, 0, autoshift_dance};
    ...
    const struct Chord chord_14 PROGMEM = {H_TOP0, QWERTY, &state_14, &counter_14, KC_P, 0, autoshift_dance};
    ...
    const struct Chord chord_15 PROGMEM = {H_TOP1 + H_BOT1, QWERTY, &state_15, &counter_15, KC_A, 0, autoshift_dance};
    ...
    const struct Chord chord_16 PROGMEM = {H_TOP2 + H_BOT2, QWERTY, &state_16, &counter_16, KC_S, 0, autoshift_dance};
    ...
    const struct Chord chord_17 PROGMEM = {H_TOP3 + H_BOT3, QWERTY, &state_17, &counter_17, KC_D, 0, autoshift_dance};
    ...
    const struct Chord chord_18 PROGMEM = {H_TOP4 + H_BOT4, QWERTY, &state_18, &counter_18, KC_F, 0, autoshift_dance};
    ...
    const struct Chord chord_19 PROGMEM = {H_TOP5 + H_BOT5, QWERTY, &state_19, &counter_19, KC_G, 0, autoshift_dance};
    ...
    const struct Chord chord_20 PROGMEM = {H_TOP6 + H_BOT6, QWERTY, &state_20, &counter_20, KC_H, 0, autoshift_dance};
    ...
    const struct Chord chord_21 PROGMEM = {H_TOP7 + H_BOT7, QWERTY, &state_21, &counter_21, KC_J, 0, autoshift_dance};
    ...
    const struct Chord chord_22 PROGMEM = {H_TOP8 + H_BOT8, QWERTY, &state_22, &counter_22, KC_K, 0, autoshift_dance};
    ...
    const struct Chord chord_23 PROGMEM = {H_TOP9 + H_BOT9, QWERTY, &state_23, &counter_23, KC_L, 0, autoshift_dance};
    ...
    const struct Chord chord_24 PROGMEM = {H_TOP0 + H_BOT0, QWERTY, &state_24, &counter_24, KC_SCOLON, 0, autoshift_dance};
    ...
    const struct Chord chord_25 PROGMEM = {H_BOT1, QWERTY, &state_25, &counter_25, KC_Z, 0, autoshift_dance};
    ...
    const struct Chord chord_26 PROGMEM = {H_BOT2, QWERTY, &state_26, &counter_26, KC_X, 0, autoshift_dance};
    ...
    const struct Chord chord_27 PROGMEM = {H_BOT3, QWERTY, &state_27, &counter_27, KC_C, 0, autoshift_dance};
    ...
    const struct Chord chord_28 PROGMEM = {H_BOT4, QWERTY, &state_28, &counter_28, KC_V, 0, autoshift_dance};
    ...
    const struct Chord chord_29 PROGMEM = {H_BOT5, QWERTY, &state_29, &counter_29, KC_B, 0, autoshift_dance};
    ...
    const struct Chord chord_30 PROGMEM = {H_BOT6, QWERTY, &state_30, &counter_30, KC_N, 0, autoshift_dance};
    ...
    const struct Chord chord_31 PROGMEM = {H_BOT7, QWERTY, &state_31, &counter_31, KC_M, 0, autoshift_dance};
    ...
    const struct Chord chord_32 PROGMEM = {H_BOT8, QWERTY, &state_32, &counter_32, KC_COMMA, 0, autoshift_dance};
    ...
    const struct Chord chord_33 PROGMEM = {H_BOT9, QWERTY, &state_33, &counter_33, KC_DOT, 0, autoshift_dance};
    ...
    const struct Chord chord_34 PROGMEM = {H_BOT0, QWERTY, &state_34, &counter_34, KC_SLASH, 0, autoshift_dance};
    ...
    const struct Chord chord_35 PROGMEM = {H_TOP1 + H_TOP2, QWERTY, &state_35, NULL, KC_ESC, 0, single_dance};
    ...
    const struct Chord chord_36 PROGMEM = {H_TOP2 + H_TOP3, QWERTY, &state_36, NULL, MOV, 0, temp_pseudolayer};
    ...
    const struct Chord chord_37 PROGMEM = {H_TOP3 + H_TOP4, QWERTY, &state_37, NULL, KC_TAB, 0, single_dance};
    ...
    const struct Chord chord_38 PROGMEM = {H_TOP5 + H_TOP6, QWERTY, &state_38, NULL, KC_RGUI, 0, one_shot_key};
    ...
    const struct Chord chord_39 PROGMEM = {H_TOP7 + H_TOP8, QWERTY, &state_39, NULL, KC_INS, 0, single_dance};
    ...
    const struct Chord chord_40 PROGMEM = {H_TOP8 + H_TOP9, QWERTY, &state_40, NULL, KC_DEL, 0, single_dance};
    ...
    const struct Chord chord_41 PROGMEM = {H_TOP9 + H_TOP0, QWERTY, &state_41, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_42 PROGMEM = {H_TOP9 + H_BOT9 + H_TOP0 + H_BOT0, QWERTY, &state_42, NULL, KC_ENTER, 0, single_dance};
    ...
    const struct Chord chord_43 PROGMEM = {H_BOT1 + H_BOT2, QWERTY, &state_43, NULL, KC_LSFT, 0, one_shot_key};
    ...
    const struct Chord chord_44 PROGMEM = {H_BOT2 + H_BOT3, QWERTY, &state_44, NULL, KC_LCTL, 0, one_shot_key};
    ...
    const struct Chord chord_45 PROGMEM = {H_BOT3 + H_BOT4, QWERTY, &state_45, NULL, KC_LALT, 0, one_shot_key};
    ...
    const struct Chord chord_46 PROGMEM = {H_BOT4 + H_BOT5, QWERTY, &state_46, NULL, NUM, 0, one_shot_layer};
    ...
    const struct Chord chord_47 PROGMEM = {H_BOT5 + H_BOT6, QWERTY, &state_47, NULL, KC_LGUI, 0, one_shot_key};
    ...
    const struct Chord chord_48 PROGMEM = {H_BOT6 + H_BOT7, QWERTY, &state_48, NULL, NUM, 0, one_shot_layer};
    ...
    const struct Chord chord_49 PROGMEM = {H_BOT7 + H_BOT8, QWERTY, &state_49, NULL, KC_RALT, 0, one_shot_key};
    ...
    const struct Chord chord_50 PROGMEM = {H_BOT8 + H_BOT9, QWERTY, &state_50, NULL, KC_RCTL, 0, one_shot_key};
    ...
    const struct Chord chord_51 PROGMEM = {H_BOT9 + H_BOT0, QWERTY, &state_51, NULL, KC_RSFT, 0, one_shot_key};
    ...
    const struct Chord chord_52 PROGMEM = {H_BOT1 + H_BOT0, QWERTY, &state_52, NULL, KC_SPACE, 0, single_dance};
    ...
    const struct Chord chord_53 PROGMEM = {H_TOP1 + H_TOP2 + H_TOP3 + H_TOP4, QWERTY, &state_53, NULL, MOUSE, 0, temp_pseudolayer};
    ...
    const struct Chord chord_89 PROGMEM = {H_TOP9 + H_BOT9 + H_TOP0 + H_BOT0, NUM, &state_89, NULL, KC_ENTER, 0, single_dance};
    ...
    const struct Chord chord_122 PROGMEM = {H_TOP1 + H_TOP0 + H_BOT1 + H_BOT0, QWERTY, &state_122, NULL, ASETNIOP, 0, perm_pseudolayer};
    ...
    const struct Chord chord_123 PROGMEM = {H_TOP1 + H_TOP0 + H_BOT1 + H_BOT0, ASETNIOP, &state_123, NULL, QWERTY, 0, perm_pseudolayer};
    ...
    const struct Chord chord_124 PROGMEM = {H_BOT4 + H_BOT7, ASETNIOP, &state_124, NULL, ASETNIOP_FN, 0, temp_pseudolayer};
    ...
    const struct Chord chord_125 PROGMEM = {H_TOP1, ASETNIOP, &state_125, NULL, KC_A, 0, single_dance};
    ...
    const struct Chord chord_126 PROGMEM = {H_TOP2, ASETNIOP, &state_126, NULL, KC_S, 0, single_dance};
    ...
    const struct Chord chord_127 PROGMEM = {H_TOP3, ASETNIOP, &state_127, NULL, KC_E, 0, single_dance};
    ...
    const struct Chord chord_128 PROGMEM = {H_TOP4, ASETNIOP, &state_128, NULL, KC_T, 0, single_dance};
    ...
    const struct Chord chord_129 PROGMEM = {H_TOP7, ASETNIOP, &state_129, NULL, KC_N, 0, single_dance};
    ...
    const struct Chord chord_130 PROGMEM = {H_TOP8, ASETNIOP, &state_130, NULL, KC_I, 0, single_dance};
    ...
    const struct Chord chord_131 PROGMEM = {H_TOP9, ASETNIOP, &state_131, NULL, KC_O, 0, single_dance};
    ...
    const struct Chord chord_132 PROGMEM = {H_TOP0, ASETNIOP, &state_132, NULL, KC_P, 0, single_dance};
    ...
    const struct Chord chord_133 PROGMEM = {H_TOP1 + H_TOP2, ASETNIOP, &state_133, NULL, KC_W, 0, single_dance};
    ...
    const struct Chord chord_134 PROGMEM = {H_TOP2 + H_TOP3, ASETNIOP, &state_134, NULL, KC_D, 0, single_dance};
    ...
    const struct Chord chord_135 PROGMEM = {H_TOP3 + H_TOP4, ASETNIOP, &state_135, NULL, KC_R, 0, single_dance};
    ...
    const struct Chord chord_136 PROGMEM = {H_TOP4 + H_TOP7, ASETNIOP, &state_136, NULL, KC_B, 0, single_dance};
    ...
    const struct Chord chord_137 PROGMEM = {H_TOP7 + H_TOP8, ASETNIOP, &state_137, NULL, KC_H, 0, single_dance};
    ...
    const struct Chord chord_138 PROGMEM = {H_TOP8 + H_TOP9, ASETNIOP, &state_138, NULL, KC_L, 0, single_dance};
    ...
    const struct Chord chord_139 PROGMEM = {H_TOP9 + H_TOP0, ASETNIOP, &state_139, NULL, KC_SCOLON, 0, single_dance};
    ...
    const struct Chord chord_140 PROGMEM = {H_TOP1 + H_TOP3, ASETNIOP, &state_140, NULL, KC_X, 0, single_dance};
    ...
    const struct Chord chord_141 PROGMEM = {H_TOP2 + H_TOP4, ASETNIOP, &state_141, NULL, KC_C, 0, single_dance};
    ...
    const struct Chord chord_142 PROGMEM = {H_TOP3 + H_TOP7, ASETNIOP, &state_142, NULL, KC_Y, 0, single_dance};
    ...
    const struct Chord chord_143 PROGMEM = {H_TOP4 + H_TOP8, ASETNIOP, &state_143, NULL, KC_V, 0, single_dance};
    ...
    const struct Chord chord_144 PROGMEM = {H_TOP7 + H_TOP9, ASETNIOP, &state_144, NULL, KC_U, 0, single_dance};
    ...
    const struct Chord chord_145 PROGMEM = {H_TOP1 + H_TOP4, ASETNIOP, &state_145, NULL, KC_F, 0, single_dance};
    ...
    const struct Chord chord_146 PROGMEM = {H_TOP2 + H_TOP7, ASETNIOP, &state_146, NULL, KC_J, 0, single_dance};
    ...
    const struct Chord chord_147 PROGMEM = {H_TOP3 + H_TOP8, ASETNIOP, &state_147, NULL, KC_COMMA, 0, single_dance};
    ...
    const struct Chord chord_148 PROGMEM = {H_TOP4 + H_TOP9, ASETNIOP, &state_148, NULL, KC_G, 0, single_dance};
    ...
    const struct Chord chord_149 PROGMEM = {H_TOP7 + H_TOP0, ASETNIOP, &state_149, NULL, KC_M, 0, single_dance};
    ...
    const struct Chord chord_150 PROGMEM = {H_TOP1 + H_TOP7, ASETNIOP, &state_150, NULL, KC_Q, 0, single_dance};
    ...
    const struct Chord chord_151 PROGMEM = {H_TOP2 + H_TOP8, ASETNIOP, &state_151, NULL, KC_K, 0, single_dance};
    ...
    const struct Chord chord_152 PROGMEM = {H_TOP3 + H_TOP9, ASETNIOP, &state_152, NULL, KC_MINUS, 0, single_dance};
    ...
    const struct Chord chord_153 PROGMEM = {H_TOP4 + H_TOP0, ASETNIOP, &state_153, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_154 PROGMEM = {H_TOP1 + H_TOP8, ASETNIOP, &state_154, NULL, KC_Z, 0, single_dance};
    ...
    const struct Chord chord_155 PROGMEM = {H_TOP2 + H_TOP9, ASETNIOP, &state_155, NULL, KC_DOT, 0, single_dance};
    ...
    const struct Chord chord_156 PROGMEM = {H_TOP3 + H_TOP0, ASETNIOP, &state_156, NULL, KC_QUOTE, 0, single_dance};
    ...
    const struct Chord chord_157 PROGMEM = {H_TOP1 + H_TOP9, ASETNIOP, &state_157, NULL, KC_LBRACKET, 0, single_dance};
    ...
    const struct Chord chord_158 PROGMEM = {H_TOP2 + H_TOP0, ASETNIOP, &state_158, NULL, KC_RBRACKET, 0, single_dance};
    ...
    const struct Chord chord_159 PROGMEM = {H_TOP1 + H_TOP0, ASETNIOP, &state_159, NULL, KC_SLASH, 0, single_dance};
    ...
    const struct Chord chord_160 PROGMEM = {H_TOP5, ASETNIOP, &state_160, NULL, KC_ESC, 0, single_dance};
    ...
    const struct Chord chord_161 PROGMEM = {H_TOP6, ASETNIOP, &state_161, NULL, KC_DEL, 0, single_dance};
    ...
    const struct Chord chord_162 PROGMEM = {H_BOT4, ASETNIOP, &state_162, NULL, KC_LSFT, 0, single_dance};
    ...
    const struct Chord chord_163 PROGMEM = {H_BOT5, ASETNIOP, &state_163, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_164 PROGMEM = {H_BOT6, ASETNIOP, &state_164, NULL, KC_LALT, 0, single_dance};
    ...
    const struct Chord chord_165 PROGMEM = {H_BOT7, ASETNIOP, &state_165, NULL, KC_SPACE, ASETNIOP_123, key_layer_dance};
    ...
    const struct Chord chord_166 PROGMEM = {H_TOP5 + H_TOP6, ASETNIOP, &state_166, NULL, KC_LGUI, 0, single_dance};
    ...
    const struct Chord chord_167 PROGMEM = {H_TOP1, ASETNIOP_123, &state_167, NULL, KC_1, 0, single_dance};
    ...
    const struct Chord chord_168 PROGMEM = {H_TOP2, ASETNIOP_123, &state_168, NULL, KC_2, 0, single_dance};
    ...
    const struct Chord chord_169 PROGMEM = {H_TOP3, ASETNIOP_123, &state_169, NULL, KC_3, 0, single_dance};
    ...
    const struct Chord chord_170 PROGMEM = {H_TOP4, ASETNIOP_123, &state_170, NULL, KC_4, 0, single_dance};
    ...
    const struct Chord chord_171 PROGMEM = {H_TOP7, ASETNIOP_123, &state_171, NULL, KC_7, 0, single_dance};
    ...
    const struct Chord chord_172 PROGMEM = {H_TOP8, ASETNIOP_123, &state_172, NULL, KC_8, 0, single_dance};
    ...
    const struct Chord chord_173 PROGMEM = {H_TOP9, ASETNIOP_123, &state_173, NULL, KC_9, 0, single_dance};
    ...
    const struct Chord chord_174 PROGMEM = {H_TOP0, ASETNIOP_123, &state_174, NULL, KC_0, 0, single_dance};
    ...
    const struct Chord chord_175 PROGMEM = {H_TOP3 + H_TOP4, ASETNIOP_123, &state_175, NULL, KC_5, 0, single_dance};
    ...
    const struct Chord chord_176 PROGMEM = {H_TOP4 + H_TOP7, ASETNIOP_123, &state_176, NULL, KC_EQUAL, 0, single_dance};
    ...
    const struct Chord chord_177 PROGMEM = {H_TOP7 + H_TOP8, ASETNIOP_123, &state_177, NULL, KC_6, 0, single_dance};
    ...
    const struct Chord chord_178 PROGMEM = {H_TOP8 + H_TOP9, ASETNIOP_123, &state_178, NULL, KC_BSLASH, 0, single_dance};
    ...
    const struct Chord chord_179 PROGMEM = {H_TOP9 + H_TOP0, ASETNIOP_123, &state_179, NULL, KC_SCOLON, 0, single_dance};
    ...
    const struct Chord chord_180 PROGMEM = {H_TOP4 + H_TOP0, ASETNIOP_123, &state_180, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_181 PROGMEM = {H_TOP5, ASETNIOP_123, &state_181, NULL, KC_ESC, 0, single_dance};
    ...
    const struct Chord chord_182 PROGMEM = {H_TOP6, ASETNIOP_123, &state_182, NULL, KC_DEL, 0, single_dance};
    ...
    const struct Chord chord_183 PROGMEM = {H_BOT4, ASETNIOP_123, &state_183, NULL, KC_LSFT, 0, single_dance};
    ...
    const struct Chord chord_184 PROGMEM = {H_BOT5, ASETNIOP_123, &state_184, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_185 PROGMEM = {H_BOT6, ASETNIOP_123, &state_185, NULL, KC_LALT, 0, single_dance};
    ...
    const struct Chord chord_186 PROGMEM = {H_TOP5 + H_TOP6, ASETNIOP_123, &state_186, NULL, KC_LGUI, 0, single_dance};
    ...
    const struct Chord chord_187 PROGMEM = {H_TOP1, ASETNIOP_FN, &state_187, NULL, KC_HOME, 0, single_dance};
    ...
    const struct Chord chord_188 PROGMEM = {H_TOP2, ASETNIOP_FN, &state_188, NULL, KC_PGDN, 0, single_dance};
    ...
    const struct Chord chord_189 PROGMEM = {H_TOP3, ASETNIOP_FN, &state_189, NULL, KC_PGUP, 0, single_dance};
    ...
    const struct Chord chord_190 PROGMEM = {H_TOP4, ASETNIOP_FN, &state_190, NULL, KC_END, 0, single_dance};
    ...
    const struct Chord chord_191 PROGMEM = {H_TOP7, ASETNIOP_FN, &state_191, NULL, KC_LEFT, 0, single_dance};
    ...
    const struct Chord chord_192 PROGMEM = {H_TOP8, ASETNIOP_FN, &state_192, NULL, KC_DOWN, 0, single_dance};
    ...
    const struct Chord chord_193 PROGMEM = {H_TOP9, ASETNIOP_FN, &state_193, NULL, KC_UP, 0, single_dance};
    ...
    const struct Chord chord_194 PROGMEM = {H_TOP0, ASETNIOP_FN, &state_194, NULL, KC_RIGHT, 0, single_dance};
    ...
    const struct Chord chord_195 PROGMEM = {H_TOP1 + H_TOP2, ASETNIOP_FN, &state_195, NULL, KC_F1, 0, single_dance};
    ...
    const struct Chord chord_196 PROGMEM = {H_TOP2 + H_TOP3, ASETNIOP_FN, &state_196, NULL, KC_F2, 0, single_dance};
    ...
    const struct Chord chord_197 PROGMEM = {H_TOP3 + H_TOP4, ASETNIOP_FN, &state_197, NULL, KC_F3, 0, single_dance};
    ...
    const struct Chord chord_198 PROGMEM = {H_TOP4 + H_TOP7, ASETNIOP_FN, &state_198, NULL, KC_F4, 0, single_dance};
    ...
    const struct Chord chord_199 PROGMEM = {H_TOP7 + H_TOP8, ASETNIOP_FN, &state_199, NULL, KC_F5, 0, single_dance};
    ...
    const struct Chord chord_200 PROGMEM = {H_TOP8 + H_TOP9, ASETNIOP_FN, &state_200, NULL, KC_F6, 0, single_dance};
    ...
    const struct Chord chord_201 PROGMEM = {H_TOP9 + H_TOP0, ASETNIOP_FN, &state_201, NULL, KC_F7, 0, single_dance};
    ...
    const struct Chord chord_202 PROGMEM = {H_TOP1 + H_TOP3, ASETNIOP_FN, &state_202, NULL, KC_F10, 0, single_dance};
    ...
    const struct Chord chord_203 PROGMEM = {H_TOP8 + H_TOP0, ASETNIOP_FN, &state_203, NULL, KC_F8, 0, single_dance};
    ...
    const struct Chord chord_204 PROGMEM = {H_TOP1 + H_TOP4, ASETNIOP_FN, &state_204, NULL, KC_F11, 0, single_dance};
    ...
    const struct Chord chord_205 PROGMEM = {H_TOP7 + H_TOP0, ASETNIOP_FN, &state_205, NULL, KC_F9, 0, single_dance};
    ...
    const struct Chord chord_206 PROGMEM = {H_TOP1 + H_TOP7, ASETNIOP_FN, &state_206, NULL, KC_F12, 0, single_dance};
    ...
    const struct Chord chord_207 PROGMEM = {H_TOP4 + H_TOP0, ASETNIOP_FN, &state_207, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_208 PROGMEM = {H_TOP5, ASETNIOP_FN, &state_208, NULL, KC_ESC, 0, single_dance};
    ...
    const struct Chord chord_209 PROGMEM = {H_TOP6, ASETNIOP_FN, &state_209, NULL, KC_DEL, 0, single_dance};
    ...
    const struct Chord chord_210 PROGMEM = {H_BOT4, ASETNIOP_FN, &state_210, NULL, KC_LSFT, 0, single_dance};
    ...
    const struct Chord chord_211 PROGMEM = {H_BOT5, ASETNIOP_FN, &state_211, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_212 PROGMEM = {H_BOT6, ASETNIOP_FN, &state_212, NULL, KC_LALT, 0, single_dance};
    ...
    const struct Chord chord_213 PROGMEM = {H_TOP5 + H_TOP6, ASETNIOP_FN, &state_213, NULL, KC_LGUI, 0, single_dance};
