...
// Add all chords
    ...
    const struct Chord chord_0 PROGMEM = {H_TOP5 + H_TOP6 + H_BOT5 + H_BOT6, ALWAYS_ON, &state_0, NULL, 0, 0, lock};
            ...
            void function_1(const struct Chord* self) {
                switch (*self->state) {
                    case ACTIVATED:
            ...
            uint8_t counter_1 = 0;
            const struct Chord chord_1 PROGMEM = {H_TOP1, QWERTY, &state_1, &counter_1, 0, 0, function_1};
    ...
    const struct Chord chord_38 PROGMEM = {H_TOP1 + H_BOT1 + H_TOP2 + H_BOT2, QWERTY, &state_38, NULL, 0, 0, str_38};
    ...
    const struct Chord chord_39 PROGMEM = {H_TOP9 + H_BOT9 + H_TOP0 + H_BOT0, QWERTY, &state_39, NULL, KC_ENTER, 0, single_dance};
    ...
    const struct Chord chord_40 PROGMEM = {H_BOT1 + H_BOT2, QWERTY, &state_40, NULL, KC_LSFT, 0, single_dance};
    ...
    const struct Chord chord_41 PROGMEM = {H_BOT2 + H_BOT3, QWERTY, &state_41, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_42 PROGMEM = {H_BOT3 + H_BOT4, QWERTY, &state_42, NULL, KC_LALT, 0, single_dance};
    ...
    const struct Chord chord_43 PROGMEM = {H_BOT4 + H_BOT5, QWERTY, &state_43, NULL, NUM, 0, temp_pseudolayer};
    ...
    const struct Chord chord_44 PROGMEM = {H_BOT5 + H_BOT6, QWERTY, &state_44, NULL, KC_LGUI, 0, single_dance};
    ...
    const struct Chord chord_45 PROGMEM = {H_BOT6 + H_BOT7, QWERTY, &state_45, NULL, NUM, 0, temp_pseudolayer};
    ...
    const struct Chord chord_46 PROGMEM = {H_BOT7 + H_BOT8, QWERTY, &state_46, NULL, KC_RALT, 0, single_dance};
    ...
    const struct Chord chord_47 PROGMEM = {H_BOT8 + H_BOT9, QWERTY, &state_47, NULL, KC_RCTL, 0, single_dance};
    ...
    const struct Chord chord_48 PROGMEM = {H_BOT9 + H_BOT0, QWERTY, &state_48, NULL, KC_RSFT, 0, single_dance};
...
void (*leader_functions[]) (void) = {};
    ...
    const struct Chord chord_49 PROGMEM = {H_BOT1 + H_BOT0, QWERTY, &state_49, NULL, KC_SPACE, 0, single_dance};
    

    
    uint8_t state_50 = IDLE;
    const struct Chord chord_50 PROGMEM = {H_TOP1 + H_TOP2 + H_TOP3 + H_TOP4, QWERTY, &state_50, NULL, MOUSE, 0, temp_pseudolayer};
    ...
    const struct Chord chord_61 PROGMEM = {H_TOP1 + H_BOT1, NUM, &state_61, NULL, KC_F1, 0, single_dance};
    ...
    const struct Chord chord_62 PROGMEM = {H_TOP2 + H_BOT2, NUM, &state_62, NULL, KC_F2, 0, single_dance};
    ...
    const struct Chord chord_63 PROGMEM = {H_TOP3 + H_BOT3, NUM, &state_63, NULL, KC_F3, 0, single_dance};
    ...
    const struct Chord chord_64 PROGMEM = {H_TOP4 + H_BOT4, NUM, &state_64, NULL, KC_F4, 0, single_dance};
    ...
    const struct Chord chord_65 PROGMEM = {H_TOP5 + H_BOT5, NUM, &state_65, NULL, KC_F5, 0, single_dance};
    ...
    const struct Chord chord_66 PROGMEM = {H_TOP6 + H_BOT6, NUM, &state_66, NULL, KC_F6, 0, single_dance};
    ...
    const struct Chord chord_67 PROGMEM = {H_TOP7 + H_BOT7, NUM, &state_67, NULL, KC_F7, 0, single_dance};
    ...
    const struct Chord chord_68 PROGMEM = {H_TOP8 + H_BOT8, NUM, &state_68, NULL, KC_F8, 0, single_dance};
    ...
    const struct Chord chord_69 PROGMEM = {H_TOP9 + H_BOT9, NUM, &state_69, NULL, KC_F9, 0, single_dance};
    ...
    const struct Chord chord_70 PROGMEM = {H_TOP0 + H_BOT0, NUM, &state_70, NULL, KC_F10, 0, single_dance};
    ...
    const struct Chord chord_74 PROGMEM = {H_BOT4, NUM, &state_74, NULL, KC_LBRACKET, 0, single_dance};
    ...
    const struct Chord chord_75 PROGMEM = {H_BOT5, NUM, &state_75, NULL, KC_RBRACKET, 0, single_dance};
    ...
    const struct Chord chord_80 PROGMEM = {H_TOP1 + H_TOP2, NUM, &state_80, NULL, KC_ESC, 0, single_dance};
    ...
    const struct Chord chord_81 PROGMEM = {H_TOP3 + H_TOP4, NUM, &state_81, NULL, KC_TAB, 0, single_dance};
    ...
    const struct Chord chord_82 PROGMEM = {H_TOP5 + H_TOP6, NUM, &state_82, NULL, KC_RGUI, 0, single_dance};
    ...
    const struct Chord chord_83 PROGMEM = {H_TOP7 + H_TOP8, NUM, &state_83, NULL, KC_INS, 0, single_dance};
    ...
    const struct Chord chord_84 PROGMEM = {H_TOP8 + H_TOP9, NUM, &state_84, NULL, KC_DEL, 0, single_dance};
    ...
    const struct Chord chord_85 PROGMEM = {H_TOP9 + H_TOP0, NUM, &state_85, NULL, KC_BSPC, 0, single_dance};
    ...
    const struct Chord chord_86 PROGMEM = {H_TOP9 + H_BOT9 + H_TOP0 + H_BOT0, NUM, &state_86, NULL, KC_ENTER, 0, single_dance};
    ...
    const struct Chord chord_87 PROGMEM = {H_BOT1 + H_BOT2, NUM, &state_87, NULL, KC_LSFT, 0, single_dance};
    ...
    const struct Chord chord_88 PROGMEM = {H_BOT2 + H_BOT3, NUM, &state_88, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_89 PROGMEM = {H_BOT3 + H_BOT4, NUM, &state_89, NULL, KC_LALT, 0, single_dance};
    ...
    const struct Chord chord_90 PROGMEM = {H_BOT5 + H_BOT6, NUM, &state_90, NULL, KC_LGUI, 0, single_dance};
    ...
    const struct Chord chord_91 PROGMEM = {H_BOT7 + H_BOT8, NUM, &state_91, NULL, KC_RALT, 0, single_dance};
    ...
    const struct Chord chord_92 PROGMEM = {H_BOT8 + H_BOT9, NUM, &state_92, NULL, KC_RCTL, 0, single_dance};
    ...
    const struct Chord chord_93 PROGMEM = {H_BOT9 + H_BOT0, NUM, &state_93, NULL, KC_RSFT, 0, single_dance};
    ...
    const struct Chord chord_94 PROGMEM = {H_BOT1 + H_BOT0, NUM, &state_94, NULL, KC_SPACE, 0, single_dance};
...
;
    ...
    const struct Chord chord_107 PROGMEM = {H_TOP7, MOUSE, &state_107, NULL, KC_MS_BTN1, 0, single_dance};
    ...
    const struct Chord chord_108 PROGMEM = {H_TOP8, MOUSE, &state_108, NULL, KC_MS_UP, 0, single_dance};
    ...
    const struct Chord chord_109 PROGMEM = {H_TOP9, MOUSE, &state_109, NULL, KC_MS_BTN2, 0, single_dance};
    ...
    const struct Chord chord_110 PROGMEM = {H_TOP0, MOUSE, &state_110, NULL, KC_MS_WH_DOWN, 0, single_dance};
    ...
    const struct Chord chord_111 PROGMEM = {H_BOT3, MOUSE, &state_111, NULL, KC_LSFT, 0, single_dance};
    ...
    const struct Chord chord_112 PROGMEM = {H_BOT4, MOUSE, &state_112, NULL, KC_LCTL, 0, single_dance};
    ...
    const struct Chord chord_113 PROGMEM = {H_BOT5, MOUSE, &state_113, NULL, KC_LALT, 0, single_dance};
    ...
    const struct Chord chord_114 PROGMEM = {H_BOT6, MOUSE, &state_114, NULL, KC_LGUI, 0, single_dance};
    ...
    const struct Chord chord_115 PROGMEM = {H_BOT7, MOUSE, &state_115, NULL, KC_MS_LEFT, 0, single_dance};
    ...
    const struct Chord chord_116 PROGMEM = {H_BOT8, MOUSE, &state_116, NULL, KC_MS_DOWN, 0, single_dance};
    ...
    const struct Chord chord_117 PROGMEM = {H_BOT9, MOUSE, &state_117, NULL, KC_MS_RIGHT, 0, single_dance};
    ...
    const struct Chord chord_118 PROGMEM = {H_BOT0, MOUSE, &state_118, NULL, KC_MS_WH_DOWN, 0, single_dance};
    ...
    const struct Chord chord_119 PROGMEM = {H_TOP1 + H_TOP0 + H_BOT1 + H_BOT0, QWERTY, &state_119, NULL, ASETNIOP, 0, perm_pseudolayer};
    

    
    uint8_t state_120 = IDLE;
    const struct Chord chord_120 PROGMEM = {H_TOP1 + H_TOP0 + H_BOT1 + H_BOT0, ASETNIOP, &state_120, NULL, QWERTY, 0, perm_pseudolayer};
    

    
    uint8_t state_121 = IDLE;
    const struct Chord chord_121 PROGMEM = {H_BOT4 + H_BOT7, ASETNIOP, &state_121, NULL, ASETNIOP_FN, 0, temp_pseudolayer};
    

    
    uint8_t state_122 = IDLE;
    const struct Chord chord_122 PROGMEM = {H_BOT7, ASETNIOP, &state_122, NULL, KC_SPACE, ASETNIOP_123, key_layer_dance};
    ...
    const struct Chord chord_148 PROGMEM = {H_TOP1 + H_TOP8, ASETNIOP, &state_148, NULL, KC_Z, 0, single_dance};
    ...
    const struct Chord chord_149 PROGMEM = {H_TOP1, ASETNIOP_123, &state_149, NULL, KC_1, 0, single_dance};
    ...
    const struct Chord chord_150 PROGMEM = {H_TOP2, ASETNIOP_123, &state_150, NULL, KC_2, 0, single_dance};
    ...
    const struct Chord chord_151 PROGMEM = {H_TOP3, ASETNIOP_123, &state_151, NULL, KC_3, 0, single_dance};
    ...
    const struct Chord chord_152 PROGMEM = {H_TOP4, ASETNIOP_123, &state_152, NULL, KC_4, 0, single_dance};
    ...
    const struct Chord chord_153 PROGMEM = {H_TOP7, ASETNIOP_123, &state_153, NULL, KC_7, 0, single_dance};
    ...
    const struct Chord chord_154 PROGMEM = {H_TOP8, ASETNIOP_123, &state_154, NULL, KC_8, 0, single_dance};
    ...
    const struct Chord chord_155 PROGMEM = {H_TOP9, ASETNIOP_123, &state_155, NULL, KC_9, 0, single_dance};
    ...
    const struct Chord chord_156 PROGMEM = {H_TOP0, ASETNIOP_123, &state_156, NULL, KC_0, 0, single_dance};
    ...
    const struct Chord chord_157 PROGMEM = {H_TOP3 + H_TOP4, ASETNIOP_123, &state_157, NULL, KC_5, 0, single_dance};
    ...
    const struct Chord chord_158 PROGMEM = {H_TOP7 + H_TOP8, ASETNIOP_123, &state_158, NULL, KC_6, 0, single_dance};
    ...
    const struct Chord chord_159 PROGMEM = {H_BOT5 + H_BOT6, ASETNIOP, &state_159, NULL, KC_LGUI, 0, single_dance};
    ...
    const struct Chord chord_165 PROGMEM = {H_BOT5 + H_BOT6, ASETNIOP_123, &state_165, NULL, KC_LGUI, 0, single_dance};
    

    
    uint8_t state_166 = IDLE;
    const struct Chord chord_166 PROGMEM = {H_TOP5, ASETNIOP_123, &state_166, NULL, KC_ESC, 0, single_dance};
    

    
    uint8_t state_167 = IDLE;
    const struct Chord chord_167 PROGMEM = {H_TOP6, ASETNIOP_123, &state_167, NULL, KC_DEL, 0, single_dance};
    

    
    uint8_t state_168 = IDLE;
    const struct Chord chord_168 PROGMEM = {H_BOT4, ASETNIOP_123, &state_168, NULL, KC_LSFT, 0, single_dance};
    

    
    uint8_t state_169 = IDLE;
    const struct Chord chord_169 PROGMEM = {H_BOT5, ASETNIOP_123, &state_169, NULL, KC_LCTL, 0, single_dance};
    

    
    uint8_t state_170 = IDLE;
    const struct Chord chord_170 PROGMEM = {H_BOT6, ASETNIOP_123, &state_170, NULL, KC_LALT, 0, single_dance};
    

    
    uint8_t state_171 = IDLE;
    const struct Chord chord_171 PROGMEM = {H_BOT5 + H_BOT6, ASETNIOP_FN, &state_171, NULL, KC_LGUI, 0, single_dance};
    

    
    uint8_t state_172 = IDLE;
    const struct Chord chord_172 PROGMEM = {H_TOP5, ASETNIOP_FN, &state_172, NULL, KC_ESC, 0, single_dance};
    

    
    uint8_t state_173 = IDLE;
    const struct Chord chord_173 PROGMEM = {H_TOP6, ASETNIOP_FN, &state_173, NULL, KC_DEL, 0, single_dance};
    

    
    uint8_t state_174 = IDLE;
    const struct Chord chord_174 PROGMEM = {H_BOT4, ASETNIOP_FN, &state_174, NULL, KC_LSFT, 0, single_dance};
    

    
    uint8_t state_175 = IDLE;
    const struct Chord chord_175 PROGMEM = {H_BOT5, ASETNIOP_FN, &state_175, NULL, KC_LCTL, 0, single_dance};
    

    
    uint8_t state_176 = IDLE;
    const struct Chord chord_176 PROGMEM = {H_BOT6, ASETNIOP_FN, &state_176, NULL, KC_LALT, 0, single_dance};
    

// Register all chords, load chording logic
#define NUM_OF_CHORDS 177
